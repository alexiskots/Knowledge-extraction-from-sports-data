...
BinaryCVSMModel01 = fitcsvm(TLrain_data01(:,1:16),TLrain_data01(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel01.Trained{1};
label01 = predict(BinaryCVSMModel01.Trained{1} ,TLest_data01(:,1:16));
%%
for i=1:81
...
BinaryCVSMModel02 = fitcsvm(TLrain_data02(:,1:16),TLrain_data02(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel02.Trained{1};
label02 = predict(BinaryCVSMModel02.Trained{1},TLest_data02(:,1:16));
...
BinaryCVSMModel03 = fitcsvm(TLrain_data03(:,1:16),TLrain_data03(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel03.Trained{1};
label03 = predict(BinaryCVSMModel03.Trained{1},TLest_data03(:,1:16));
...
BinaryCVSMModel04 = fitcsvm(TLrain_data04(:,1:16),TLrain_data04(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel04.Trained{1};
label04 = predict(BinaryCVSMModel04.Trained{1},TLest_data04(:,1:16));
...
BinaryCVSMModel05 = fitcsvm(TLrain_data05(:,1:16),TLrain_data05(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel05.Trained{1};
label05 = predict(BinaryCVSMModel05.Trained{1},TLest_data05(:,1:16));
...
BinaryCVSMModel06 = fitcsvm(TLrain_data06(:,1:16),TLrain_data06(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel06.Trained{1};
label06 = predict(BinaryCVSMModel06.Trained{1},TLest_data06(:,1:16));
...
BinaryCVSMModel07 = fitcsvm(TLrain_data07(:,1:16),TLrain_data07(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel07.Trained{1};
label07= predict(BinaryCVSMModel07.Trained{1},TLest_data07(:,1:16));
...
BinaryCVSMModel08 = fitcsvm(TLrain_data08(:,1:16),TLrain_data08(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel08.Trained{1};
label08= predict(BinaryCVSMModel08.Trained{1},TLest_data08(:,1:16));
...
BinaryCVSMModel09 = fitcsvm(TLrain_data09(:,1:16),TLrain_data09(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel09.Trained{1};
label09= predict(BinaryCVSMModel09.Trained{1},TLest_data09(:,1:16));
...
BinaryCVSMModel10 = fitcsvm(TLrain_data10(:,1:16),TLrain_data10(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel10.Trained{1};
label10 = predict(BinaryCVSMModel10.Trained{1},TLest_data10(:,1:16));
...
BinaryCVSMModel11 = fitcsvm(TLrain_data11(:,1:16),TLrain_data11(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel11.Trained{1};
label11 = predict(BinaryCVSMModel11.Trained{1},TLest_data11(:,1:16));
...
BinaryCVSMModel12 = fitcsvm(TLrain_data12(:,1:16),TLrain_data12(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel12.Trained{1};
label12 = predict(BinaryCVSMModel12.Trained{1},TLest_data12(:,1:16));
...
BinaryCVSMModel13 = fitcsvm(TLrain_data13(:,1:16),TLrain_data13(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel13.Trained{1};
label13 = predict(BinaryCVSMModel13.Trained{1},TLest_data13(:,1:16));
...
BinaryCVSMModel14 = fitcsvm(TLrain_data14(:,1:16),TLrain_data14(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel14.Trained{1};
label14= predict(BinaryCVSMModel14.Trained{1},TLest_data14(:,1:16));
...
BinaryCVSMModel15 = fitcsvm(TLrain_data15(:,1:16),TLrain_data15(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel15.Trained{1};
label15 = predict(BinaryCVSMModel15.Trained{1},TLest_data15(:,1:16));
...
BinaryCVSMModel16 = fitcsvm(TLrain_data16(:,1:16),TLrain_data16(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel16.Trained{1};
label16 = predict(BinaryCVSMModel16.Trained{1},TLest_data16(:,1:16));
...
BinaryCVSMModel17 = fitcsvm(TLrain_data17(:,1:16),TLrain_data17(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel17.Trained{1};
label17 = predict(BinaryCVSMModel17.Trained{1},TLest_data17(:,1:16));
...
BinaryCVSMModel18 = fitcsvm(TLrain_data18(:,1:16),TLrain_data18(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel18.Trained{1};
[label18,kscore18] = predict(BinaryCVSMModel18.Trained{1},TLest_data18(:,1:16));
...
BinaryCVSMModel19 = fitcsvm(TLrain_data19(:,1:16),TLrain_data19(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel19.Trained{1};
label19 = predict(BinaryCVSMModel19.Trained{1},TLest_data19(:,1:16));
...
BinaryCVSMModel20 = fitcsvm(TLrain_data20(:,1:16),TLrain_data20(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel20.Trained{1};
label20= predict(BinaryCVSMModel20.Trained{1},TLest_data20(:,1:16));
...
BinaryCVSMModel21 = fitcsvm(TLrain_data21(:,1:16),TLrain_data21(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel21.Trained{1};
label21 = predict(BinaryCVSMModel21.Trained{1},TLest_data21(:,1:16));
...
BinaryCVSMModel22 = fitcsvm(TLrain_data22(:,1:16),TLrain_data22(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel22.Trained{1};
label22 = predict(BinaryCVSMModel22.Trained{1},TLest_data22(:,1:16));
...
BinaryCVSMModel23 = fitcsvm(TLrain_data23(:,1:16),TLrain_data23(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel23.Trained{1};
label23 = predict(BinaryCVSMModel23.Trained{1},TLest_data23(:,1:16));
...
BinaryCVSMModel24 = fitcsvm(TLrain_data24(:,1:16),TLrain_data24(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel24.Trained{1};
label24= predict(BinaryCVSMModel24.Trained{1},TLest_data24(:,1:16));
...
BinaryCVSMModel25 = fitcsvm(TLrain_data25(:,1:16),TLrain_data25(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel25.Trained{1};
label25 = predict(BinaryCVSMModel25.Trained{1},TLest_data25(:,1:16));
...
BinaryCVSMModel26 = fitcsvm(TLrain_data26(:,1:16),TLrain_data26(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel26.Trained{1};
label26= predict(BinaryCVSMModel26.Trained{1},TLest_data26(:,1:16));
...
BinaryCVSMModel27 = fitcsvm(TLrain_data27(:,1:16),TLrain_data27(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel27.Trained{1};
label27 = predict(BinaryCVSMModel27.Trained{1},TLest_data27(:,1:16));
...
BinaryCVSMModel28 = fitcsvm(TLrain_data28(:,1:16),TLrain_data28(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel28.Trained{1};
label28= predict(BinaryCVSMModel28.Trained{1},TLest_data28(:,1:16));
...
BinaryCVSMModel29 = fitcsvm(TLrain_data29(:,1:16),TLrain_data29(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel29.Trained{1};
label29 = predict(BinaryCVSMModel29.Trained{1},TLest_data29(:,1:16));
...
BinaryCVSMModel30 = fitcsvm(TLrain_data30(:,1:16),TLrain_data30(:,17),'CrossVal','on' ,'Standardize',true);
BinaryCVSMModel30.Trained{1};
label30= predict(BinaryCVSMModel30.Trained{1},TLest_data30(:,1:16));