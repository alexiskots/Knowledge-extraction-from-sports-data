%% recal binary class c =4
L01= loss(BinaryCVSMModel01.Trained{1},TLest_data01(:,1:32),TLest_data01(:,33));
ConfusionTest01= confusionchart(TLest_data01(:,33),label01(:,1));
confMatrix01= confusionmat(TLest_data01(:,33),label01(:,1));
...
%%
L02= loss(BinaryCVSMModel02.Trained{1},TLest_data02(:,1:32),TLest_data02(:,33));
ConfusionTest02= confusionchart(TLest_data02(:,33),label02(:,1));
confMatrix02= confusionmat(TLest_data02(:,33),label02(:,1));
...
%%
L03= loss(BinaryCVSMModel03.Trained{1},TLest_data03(:,1:32),TLest_data03(:,33));
ConfusionTest03= confusionchart(TLest_data03(:,33),label03(:,1));
confMatrix03= confusionmat(TLest_data03(:,33),label03(:,1));
...
%%
L04= loss(BinaryCVSMModel04.Trained{1},TLest_data04(:,1:32),TLest_data04(:,33));
ConfusionTest04= confusionchart(TLest_data04(:,33),label04(:,1));
confMatrix04= confusionmat(TLest_data04(:,33),label04(:,1));
...
%%
L05= loss(BinaryCVSMModel05.Trained{1},TLest_data05(:,1:32),TLest_data05(:,33));
ConfusionTest05= confusionchart(TLest_data05(:,33),label05(:,1));
confMatrix05= confusionmat(TLest_data05(:,33),label05(:,1));
...
%%
L06= loss(BinaryCVSMModel06.Trained{1},TLest_data06(:,1:32),TLest_data06(:,33));
ConfusionTest06= confusionchart(TLest_data06(:,33),label06(:,1));
confMatrix06= confusionmat(TLest_data06(:,33),label06(:,1));
...
%%
L07= loss(BinaryCVSMModel07.Trained{1},TLest_data07(:,1:32),TLest_data07(:,33));
ConfusionTest07= confusionchart(TLest_data07(:,33),label07(:,1));
confMatrix07= confusionmat(TLest_data07(:,33),label07(:,1));
...
%%
L08= loss(BinaryCVSMModel08.Trained{1},TLest_data08(:,1:32),TLest_data08(:,33));
ConfusionTest08= confusionchart(TLest_data08(:,33),label08(:,1));
confMatrix08= confusionmat(TLest_data08(:,33),label08(:,1));
...
%%
L09= loss(BinaryCVSMModel09.Trained{1},TLest_data09(:,1:32),TLest_data09(:,33));
ConfusionTest09= confusionchart(TLest_data09(:,33),label09(:,1));
confMatrix09 = confusionmat(TLest_data09(:,33),label09(:,1));
...
%%
L10= loss(BinaryCVSMModel10.Trained{1},TLest_data10(:,1:32),TLest_data10(:,33));
ConfusionTest10= confusionchart(TLest_data10(:,33),label10(:,1));
confMatrix10 = confusionmat(TLest_data10(:,33),label10(:,1));
...
%%
L11= loss(BinaryCVSMModel11.Trained{1},TLest_data11(:,1:32),TLest_data11(:,33));
ConfusionTest11= confusionchart(TLest_data11(:,33),label11(:,1));
confMatrix11 = confusionmat(TLest_data11(:,33),label11(:,1));
...
%%
L12= loss(BinaryCVSMModel12.Trained{1},TLest_data12(:,1:32),TLest_data12(:,33));
ConfusionTest12= confusionchart(TLest_data12(:,33),label12(:,1));
confMatrix12 = confusionmat(TLest_data12(:,33),label12(:,1));
...
%%
L13= loss(BinaryCVSMModel13.Trained{1},TLest_data13(:,1:32),TLest_data13(:,33));
ConfusionTest13= confusionchart(TLest_data13(:,33),label13(:,1));
confMatrix13 = confusionmat(TLest_data13(:,33),label13(:,1));
...
%%
L14= loss(BinaryCVSMModel14.Trained{1},TLest_data14(:,1:32),TLest_data14(:,33));
ConfusionTest14= confusionchart(TLest_data14(:,33),label14(:,1));
confMatrix14 = confusionmat(TLest_data14(:,33),label14(:,1));
...
%%
L15= loss(BinaryCVSMModel15.Trained{1},TLest_data15(:,1:32),TLest_data15(:,33));
ConfusionTest15= confusionchart(TLest_data15(:,33),label15(:,1));
confMatrix15 = confusionmat(TLest_data15(:,33),label15(:,1));
...
%%
L16= loss(BinaryCVSMModel16.Trained{1},TLest_data16(:,1:32),TLest_data16(:,33));
ConfusionTest16= confusionchart(TLest_data16(:,33),label16(:,1));
confMatrix16 = confusionmat(TLest_data16(:,33),label16(:,1));
...
%%
L17= loss(BinaryCVSMModel17.Trained{1},TLest_data17(:,1:32),TLest_data17(:,33));
ConfusionTest17= confusionchart(TLest_data17(:,33),label17(:,1));
confMatrix17 = confusionmat(TLest_data17(:,33),label17(:,1));
...
%%
L18= loss(BinaryCVSMModel18.Trained{1},TLest_data18(:,1:32),TLest_data18(:,33));
ConfusionTest18= confusionchart(TLest_data18(:,33),label18(:,1));
confMatrix18 = confusionmat(TLest_data18(:,33),label18(:,1));
...
%%
L19= loss(BinaryCVSMModel19.Trained{1},TLest_data19(:,1:32),TLest_data19(:,33));
ConfusionTest19= confusionchart(TLest_data19(:,33),label19(:,1));
confMatrix19 = confusionmat(TLest_data19(:,33),label19(:,1));
...
%%
L20= loss(BinaryCVSMModel20.Trained{1},TLest_data20(:,1:32),TLest_data20(:,33));
ConfusionTest20= confusionchart(TLest_data20(:,33),label20(:,1));
confMatrix20 = confusionmat(TLest_data20(:,33),label20(:,1));
...
%%
L21 = loss(BinaryCVSMModel21.Trained{1},TLest_data21(:,1:32),TLest_data21(:,33));
ConfusionTest21= confusionchart(TLest_data21(:,33),label21(:,1));
confMatrix21 = confusionmat(TLest_data21(:,33),label21(:,1));
...
%%
L22 = loss(BinaryCVSMModel22.Trained{1},TLest_data22(:,1:32),TLest_data22(:,33));
ConfusionTest22= confusionchart(TLest_data22(:,33),label22(:,1));
confMatrix22 = confusionmat(TLest_data22(:,33),label22(:,1));
...
%%
L23 = loss(BinaryCVSMModel23.Trained{1},TLest_data23(:,1:32),TLest_data23(:,33));
ConfusionTest23= confusionchart(TLest_data23(:,33),label23(:,1));
confMatrix23 = confusionmat(TLest_data23(:,33),label23(:,1));
...
%%
L24 = loss(BinaryCVSMModel24.Trained{1},TLest_data24(:,1:32),TLest_data24(:,33));
ConfusionTest24= confusionchart(TLest_data24(:,33),label24(:,1));
confMatrix24 = confusionmat(TLest_data24(:,33),label24(:,1));
...
%%
L25 = loss(BinaryCVSMModel25.Trained{1},TLest_data25(:,1:32),TLest_data25(:,33));
ConfusionTest25= confusionchart(TLest_data25(:,33),label25(:,1));
confMatrix25 = confusionmat(TLest_data25(:,33),label25(:,1));
...
%%
L26 = loss(BinaryCVSMModel26.Trained{1},TLest_data26(:,1:32),TLest_data26(:,33));
ConfusionTest26= confusionchart(TLest_data26(:,33),label26(:,1));
confMatrix26 = confusionmat(TLest_data26(:,33),label26(:,1));
...
%%
L27 = loss(BinaryCVSMModel27.Trained{1},TLest_data27(:,1:32),TLest_data27(:,33));
ConfusionTest27= confusionchart(TLest_data27(:,33),label27(:,1));
confMatrix27 = confusionmat(TLest_data27(:,33),label27(:,1));
...
%%
L28 = loss(BinaryCVSMModel28.Trained{1},TLest_data28(:,1:32),TLest_data28(:,33));
ConfusionTest28= confusionchart(TLest_data28(:,33),label28(:,1));
confMatrix28 = confusionmat(TLest_data28(:,33),label28(:,1));
...
%%
L29 = loss(BinaryCVSMModel29.Trained{1},TLest_data29(:,1:32),TLest_data29(:,33));
ConfusionTest29= confusionchart(TLest_data29(:,33),label29(:,1));
confMatrix29 = confusionmat(TLest_data29(:,33),label29(:,1));
...
%%
L30 = loss(BinaryCVSMModel30.Trained{1},TLest_data30(:,1:32),TLest_data30(:,33));
ConfusionTest30= confusionchart(TLest_data30(:,33),label30(:,1));
confMatrix30 = confusionmat(TLest_data30(:,33),label30(:,1));
