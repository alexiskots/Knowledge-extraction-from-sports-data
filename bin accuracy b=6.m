%% recal binary class c =6
L01= loss(BinaryCVSMModel01.Trained{1},TLest_data01(:,1:48),TLest_data01(:,49));
ConfusionTest01= confusionchart(TLest_data01(:,49),label01(:,1));
confMatrix01= confusionmat(TLest_data01(:,49),label01(:,1));
...
%%
L02= loss(BinaryCVSMModel02.Trained{1},TLest_data02(:,1:48),TLest_data02(:,49));
ConfusionTest02= confusionchart(TLest_data02(:,49),label02(:,1));
confMatrix02= confusionmat(TLest_data02(:,49),label02(:,1));
...
%%
L03= loss(BinaryCVSMModel03.Trained{1},TLest_data03(:,1:48),TLest_data03(:,49));
ConfusionTest03= confusionchart(TLest_data03(:,49),label03(:,1));
confMatrix03= confusionmat(TLest_data03(:,49),label03(:,1));
...
%%
L04= loss(BinaryCVSMModel04.Trained{1},TLest_data04(:,1:48),TLest_data04(:,49));
ConfusionTest04= confusionchart(TLest_data04(:,49),label04(:,1));
confMatrix04= confusionmat(TLest_data04(:,49),label04(:,1));
...
%%
L05= loss(BinaryCVSMModel05.Trained{1},TLest_data05(:,1:48),TLest_data05(:,49));
ConfusionTest05= confusionchart(TLest_data05(:,49),label05(:,1));
confMatrix05= confusionmat(TLest_data05(:,49),label05(:,1));
...
%%
L06= loss(BinaryCVSMModel06.Trained{1},TLest_data06(:,1:48),TLest_data06(:,49));
ConfusionTest06= confusionchart(TLest_data06(:,49),label06(:,1));
confMatrix06= confusionmat(TLest_data06(:,49),label06(:,1));
...
%%
L07= loss(BinaryCVSMModel07.Trained{1},TLest_data07(:,1:48),TLest_data07(:,49));
ConfusionTest07= confusionchart(TLest_data07(:,49),label07(:,1));
confMatrix07= confusionmat(TLest_data07(:,49),label07(:,1));
...
%%
L08= loss(BinaryCVSMModel08.Trained{1},TLest_data08(:,1:48),TLest_data08(:,49));
ConfusionTest08= confusionchart(TLest_data08(:,49),label08(:,1));
confMatrix08= confusionmat(TLest_data08(:,49),label08(:,1));
...
%%
L09= loss(BinaryCVSMModel09.Trained{1},TLest_data09(:,1:48),TLest_data09(:,49));
ConfusionTest09= confusionchart(TLest_data09(:,49),label09(:,1));
confMatrix09 = confusionmat(TLest_data09(:,49),label09(:,1));
...
%%
L10= loss(BinaryCVSMModel10.Trained{1},TLest_data10(:,1:48),TLest_data10(:,49));
ConfusionTest10= confusionchart(TLest_data10(:,49),label10(:,1));
confMatrix10 = confusionmat(TLest_data10(:,49),label10(:,1));
...
%%
L11= loss(BinaryCVSMModel11.Trained{1},TLest_data11(:,1:48),TLest_data11(:,49));
ConfusionTest11= confusionchart(TLest_data11(:,49),label11(:,1));
confMatrix11 = confusionmat(TLest_data11(:,49),label11(:,1));
...
%%
L12= loss(BinaryCVSMModel12.Trained{1},TLest_data12(:,1:48),TLest_data12(:,49));
ConfusionTest12= confusionchart(TLest_data12(:,49),label12(:,1));
confMatrix12 = confusionmat(TLest_data12(:,49),label12(:,1));
...
%%
L13= loss(BinaryCVSMModel13.Trained{1},TLest_data13(:,1:48),TLest_data13(:,49));
ConfusionTest13= confusionchart(TLest_data13(:,49),label13(:,1));
confMatrix13 = confusionmat(TLest_data13(:,49),label13(:,1));
...
%%
L14= loss(BinaryCVSMModel14.Trained{1},TLest_data14(:,1:48),TLest_data14(:,49));
ConfusionTest14= confusionchart(TLest_data14(:,49),label14(:,1));
confMatrix14 = confusionmat(TLest_data14(:,49),label14(:,1));
...
%%
L15= loss(BinaryCVSMModel15.Trained{1},TLest_data15(:,1:48),TLest_data15(:,49));
ConfusionTest15= confusionchart(TLest_data15(:,49),label15(:,1));
confMatrix15 = confusionmat(TLest_data15(:,49),label15(:,1));
...
%%
L16= loss(BinaryCVSMModel16.Trained{1},TLest_data16(:,1:48),TLest_data16(:,49));
ConfusionTest16= confusionchart(TLest_data16(:,49),label16(:,1));
confMatrix16 = confusionmat(TLest_data16(:,49),label16(:,1));
...
%%
L17= loss(BinaryCVSMModel17.Trained{1},TLest_data17(:,1:48),TLest_data17(:,49));
ConfusionTest17= confusionchart(TLest_data17(:,49),label17(:,1));
confMatrix17 = confusionmat(TLest_data17(:,49),label17(:,1));
...
%%
L18= loss(BinaryCVSMModel18.Trained{1},TLest_data18(:,1:48),TLest_data18(:,49));
ConfusionTest18= confusionchart(TLest_data18(:,49),label18(:,1));
confMatrix18 = confusionmat(TLest_data18(:,49),label18(:,1));
...
%%
L19= loss(BinaryCVSMModel19.Trained{1},TLest_data19(:,1:48),TLest_data19(:,49));
ConfusionTest19= confusionchart(TLest_data19(:,49),label19(:,1));
confMatrix19 = confusionmat(TLest_data19(:,49),label19(:,1));
...
%%
L20= loss(BinaryCVSMModel20.Trained{1},TLest_data20(:,1:48),TLest_data20(:,49));
ConfusionTest20= confusionchart(TLest_data20(:,49),label20(:,1));
confMatrix20 = confusionmat(TLest_data20(:,49),label20(:,1));
...
%%
L21 = loss(BinaryCVSMModel21.Trained{1},TLest_data21(:,1:48),TLest_data21(:,49));
ConfusionTest21= confusionchart(TLest_data21(:,49),label21(:,1));
confMatrix21 = confusionmat(TLest_data21(:,49),label21(:,1));
...
%%
L22 = loss(BinaryCVSMModel22.Trained{1},TLest_data22(:,1:48),TLest_data22(:,49));
ConfusionTest22= confusionchart(TLest_data22(:,49),label22(:,1));
confMatrix22 = confusionmat(TLest_data22(:,49),label22(:,1));
...
%%
L23 = loss(BinaryCVSMModel23.Trained{1},TLest_data23(:,1:48),TLest_data23(:,49));
ConfusionTest23= confusionchart(TLest_data23(:,49),label23(:,1));
confMatrix23 = confusionmat(TLest_data23(:,49),label23(:,1));
...
%%
L24 = loss(BinaryCVSMModel24.Trained{1},TLest_data24(:,1:48),TLest_data24(:,49));
ConfusionTest24= confusionchart(TLest_data24(:,49),label24(:,1));
confMatrix24 = confusionmat(TLest_data24(:,49),label24(:,1));
...
%%
L25 = loss(BinaryCVSMModel25.Trained{1},TLest_data25(:,1:48),TLest_data25(:,49));
ConfusionTest25= confusionchart(TLest_data25(:,49),label25(:,1));
confMatrix25 = confusionmat(TLest_data25(:,49),label25(:,1));
...
%%
L26 = loss(BinaryCVSMModel26.Trained{1},TLest_data26(:,1:48),TLest_data26(:,49));
ConfusionTest26= confusionchart(TLest_data26(:,49),label26(:,1));
confMatrix26 = confusionmat(TLest_data26(:,49),label26(:,1));
...
%%
L27 = loss(BinaryCVSMModel27.Trained{1},TLest_data27(:,1:48),TLest_data27(:,49));
ConfusionTest27= confusionchart(TLest_data27(:,49),label27(:,1));
confMatrix27 = confusionmat(TLest_data27(:,49),label27(:,1));
...
%%
L28 = loss(BinaryCVSMModel28.Trained{1},TLest_data28(:,1:48),TLest_data28(:,49));
ConfusionTest28= confusionchart(TLest_data28(:,49),label28(:,1));
confMatrix28 = confusionmat(TLest_data28(:,49),label28(:,1));
...
%%
L29 = loss(BinaryCVSMModel29.Trained{1},TLest_data29(:,1:48),TLest_data29(:,49));
ConfusionTest29= confusionchart(TLest_data29(:,49),label29(:,1));
confMatrix29 = confusionmat(TLest_data29(:,49),label29(:,1));
...
%%
L30 = loss(BinaryCVSMModel30.Trained{1},TLest_data30(:,1:48),TLest_data30(:,49));
ConfusionTest30= confusionchart(TLest_data30(:,49),label30(:,1));
confMatrix30 = confusionmat(TLest_data30(:,49),label30(:,1));
