%%for c=4
cubconfMatrix01= confusionmat(TLest_data01(:,33),cublabel01(:,1));
...
cubL01 = loss(partitionedModel01.Trained{1},TLest_data01(:,1:32),TLest_data01(:,33));
cubConfusionTest01 = confusionchart(TLest_data01(:,33),cublabel01(:,1));
%%
cubconfMatrix02= confusionmat(TLest_data02(:,33),cublabel02(:,1));
...
cubL02 = loss(partitionedModel02.Trained{1},TLest_data02(:,1:32),TLest_data02(:,33));
cubConfusionTest02 = confusionchart(TLest_data02(:,33),cublabel02(:,1));
%%
cubconfMatrix03= confusionmat(TLest_data03(:,33),cublabel03(:,1));
...
cubL03 = loss(partitionedModel03.Trained{1},TLest_data03(:,1:32),TLest_data03(:,33));
cubConfusionTest03 = confusionchart(TLest_data03(:,33),cublabel03(:,1));
%%
cubconfMatrix04= confusionmat(TLest_data04(:,33),cublabel04(:,1));
...
cubL04 = loss(partitionedModel04.Trained{1},TLest_data04(:,1:32),TLest_data04(:,33));
cubConfusionTest04 = confusionchart(TLest_data04(:,33),cublabel04(:,1));
%%
cubconfMatrix05= confusionmat(TLest_data05(:,33),cublabel05(:,1));
...
cubL05 = loss(partitionedModel05.Trained{1},TLest_data05(:,1:32),TLest_data05(:,33));
cubConfusionTest05 = confusionchart(TLest_data05(:,33),cublabel05(:,1));
%%
cubconfMatrix06= confusionmat(TLest_data06(:,33),cublabel06(:,1));
...
cubL06 = loss(partitionedModel06.Trained{1},TLest_data06(:,1:32),TLest_data06(:,33));
cubConfusionTest06 = confusionchart(TLest_data06(:,33),cublabel06(:,1));
%%
cubconfMatrix07= confusionmat(TLest_data07(:,33),cublabel07(:,1));
...
cubL07 = loss(partitionedModel07.Trained{1},TLest_data07(:,1:32),TLest_data07(:,33));
cubConfusionTest07 = confusionchart(TLest_data07(:,33),cublabel07(:,1));
%%
cubconfMatrix08= confusionmat(TLest_data08(:,33),cublabel08(:,1));
...
cubL08 = loss(partitionedModel08.Trained{1},TLest_data08(:,1:32),TLest_data08(:,33));
cubConfusionTest08 = confusionchart(TLest_data08(:,33),cublabel08(:,1));
%%
cubconfMatrix09= confusionmat(TLest_data09(:,33),cublabel09(:,1));
...
cubL09 = loss(partitionedModel09.Trained{1},TLest_data09(:,1:32),TLest_data09(:,33));
cubConfusionTest09 = confusionchart(TLest_data09(:,33),cublabel09(:,1));
%%
cubconfMatrix10= confusionmat(TLest_data10(:,33),cublabel10(:,1));
...
cubL10 = loss(partitionedModel10.Trained{1},TLest_data10(:,1:32),TLest_data10(:,33));
cubConfusionTest10 = confusionchart(TLest_data10(:,33),cublabel10(:,1));
%%
cubconfMatrix11= confusionmat(TLest_data11(:,33),cublabel11(:,1));
...
cubL11 = loss(partitionedModel11.Trained{1},TLest_data11(:,1:32),TLest_data11(:,33));
cubConfusionTest11 = confusionchart(TLest_data11(:,33),cublabel11(:,1));
%%
cubconfMatrix12= confusionmat(TLest_data12(:,33),cublabel12(:,1));
...
cubL12 = loss(partitionedModel12.Trained{1},TLest_data12(:,1:32),TLest_data12(:,33));
cubConfusionTest12 = confusionchart(TLest_data12(:,33),cublabel12(:,1));
%%
cubconfMatrix13= confusionmat(TLest_data13(:,33),cublabel13(:,1));
...
cubL13 = loss(partitionedModel13.Trained{1},TLest_data13(:,1:32),TLest_data13(:,33));
cubConfusionTest13 = confusionchart(TLest_data13(:,33),cublabel13(:,1));
%%
cubconfMatrix14= confusionmat(TLest_data14(:,33),cublabel14(:,1));
...
cubL14 = loss(partitionedModel14.Trained{1},TLest_data14(:,1:32),TLest_data14(:,33));
cubConfusionTest14 = confusionchart(TLest_data14(:,33),cublabel14(:,1));
%%
cubconfMatrix15= confusionmat(TLest_data15(:,33),cublabel15(:,1));
...
cubL15 = loss(partitionedModel15.Trained{1},TLest_data15(:,1:32),TLest_data15(:,33));
cubConfusionTest15 = confusionchart(TLest_data15(:,33),cublabel15(:,1));
%%
cubconfMatrix16= confusionmat(TLest_data16(:,33),cublabel16(:,1));
...
cubL16 = loss(partitionedModel16.Trained{1},TLest_data16(:,1:32),TLest_data16(:,33));
cubConfusionTest16 = confusionchart(TLest_data16(:,33),cublabel16(:,1));
%%
cubconfMatrix17= confusionmat(TLest_data17(:,33),cublabel17(:,1));
...
cubL17 = loss(partitionedModel17.Trained{1},TLest_data17(:,1:32),TLest_data17(:,33));
cubConfusionTest17 = confusionchart(TLest_data17(:,33),cublabel17(:,1));
%%
cubconfMatrix18= confusionmat(TLest_data18(:,33),cublabel18(:,1));
...
cubL18 = loss(partitionedModel18.Trained{1},TLest_data18(:,1:32),TLest_data18(:,33));
cubConfusionTest18 = confusionchart(TLest_data18(:,33),cublabel18(:,1));
%%
cubconfMatrix19= confusionmat(TLest_data19(:,33),cublabel19(:,1));
...
cubL19 = loss(partitionedModel19.Trained{1},TLest_data19(:,1:32),TLest_data19(:,33));
cubConfusionTest19 = confusionchart(TLest_data19(:,33),cublabel19(:,1));
%%
cubconfMatrix20= confusionmat(TLest_data20(:,33),cublabel20(:,1));
...
cubL20 = loss(partitionedModel20.Trained{1},TLest_data20(:,1:32),TLest_data20(:,33));
cubConfusionTest20 = confusionchart(TLest_data20(:,33),cublabel20(:,1));
%%
cubconfMatrix21= confusionmat(TLest_data21(:,33),cublabel21(:,1));
...
cubL21= loss(partitionedModel21.Trained{1},TLest_data21(:,1:32),TLest_data21(:,33));
cubConfusionTest21 = confusionchart(TLest_data21(:,33),cublabel21(:,1));
%%
cubconfMatrix22= confusionmat(TLest_data22(:,33),cublabel22(:,1));
...
cubL22= loss(partitionedModel22.Trained{1},TLest_data22(:,1:32),TLest_data22(:,33));
cubConfusionTest22 = confusionchart(TLest_data22(:,33),cublabel22(:,1));
%%
cubconfMatrix23= confusionmat(TLest_data23(:,33),cublabel23(:,1));
...
cubL23= loss(partitionedModel23.Trained{1},TLest_data23(:,1:32),TLest_data23(:,33));
cubConfusionTest23 = confusionchart(TLest_data23(:,33),cublabel23(:,1));
%%
cubconfMatrix24= confusionmat(TLest_data24(:,33),cublabel24(:,1));
...
cubL24= loss(partitionedModel24.Trained{1},TLest_data24(:,1:32),TLest_data24(:,33));
cubConfusionTest24 = confusionchart(TLest_data24(:,33),cublabel24(:,1));
%%
cubconfMatrix25= confusionmat(TLest_data25(:,33),cublabel25(:,1));
...
cubL25= loss(partitionedModel25.Trained{1},TLest_data25(:,1:32),TLest_data25(:,33));
cubConfusionTest25 = confusionchart(TLest_data25(:,33),cublabel25(:,1));
%%
cubconfMatrix26= confusionmat(TLest_data26(:,33),cublabel26(:,1));
...
cubL26= loss(partitionedModel26.Trained{1},TLest_data26(:,1:32),TLest_data26(:,33));
cubConfusionTest26 = confusionchart(TLest_data26(:,33),cublabel26(:,1));
%%
cubconfMatrix27= confusionmat(TLest_data27(:,33),cublabel27(:,1));
...
cubL27= loss(partitionedModel27.Trained{1},TLest_data27(:,1:32),TLest_data27(:,33));
cubConfusionTest27 = confusionchart(TLest_data27(:,33),cublabel27(:,1));
%%
cubconfMatrix28= confusionmat(TLest_data28(:,33),cublabel28(:,1));
...
cubL28= loss(partitionedModel28.Trained{1},TLest_data28(:,1:32),TLest_data28(:,33));
cubConfusionTest28 = confusionchart(TLest_data28(:,33),cublabel28(:,1));
%%
cubconfMatrix29= confusionmat(TLest_data29(:,33),cublabel29(:,1));
...
cubL29= loss(partitionedModel29.Trained{1},TLest_data29(:,1:32),TLest_data29(:,33));
cubConfusionTest29 = confusionchart(TLest_data29(:,33),cublabel29(:,1));
%%
cubconfMatrix30= confusionmat(TLest_data30(:,33),cublabel30(:,1));
...
cubL30= loss(partitionedModel30.Trained{1},TLest_data30(:,1:32),TLest_data30(:,33));
cubConfusionTest30 = confusionchart(TLest_data30(:,33),cublabel30(:,1));
%%
