...
%%
KernelCVSVMModel01 = fitcsvm(TLrain_data01(:,1:16),TLrain_data01(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1,  'BoxConstraint',1.1522,'Standardize',true,'ClassNames', [0; 1]);
KernpartitionedModel01 = crossval(KernelCVSVMModel01, 'KFold', 10);
KernpartitionedModel01.Trained{1};
klabel01 = predict( KernpartitionedModel01.Trained{1},TLest_data01(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel02 = fitcsvm(TLrain_data02(:,1:16),TLrain_data02(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint',  1.1522,'Standardize', true ,'ClassNames', [0; 1]);
KernpartitionedModel02 = crossval(KernelCVSVMModel02, 'KFold', 10);
KernpartitionedModel02.Trained{1};
klabel02 = predict( KernpartitionedModel02.Trained{1},TLest_data02(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel03= fitcsvm(TLrain_data03(:,1:16),TLrain_data03(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel03 = crossval(KernelCVSVMModel03, 'KFold', 10);
KernpartitionedModel03.Trained{1};
klabel03 = predict( KernpartitionedModel03.Trained{1},TLest_data03(:,1:16));
%%
...
%%
KernelCVSVMModel04= fitcsvm(TLrain_data04(:,1:16),TLrain_data04(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel04 = crossval(KernelCVSVMModel04, 'KFold', 10);
KernpartitionedModel04.Trained{1};
klabel04 = predict( KernpartitionedModel04.Trained{1},TLest_data04(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel05= fitcsvm(TLrain_data05(:,1:16),TLrain_data05(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1,  'BoxConstraint', 1.1522,'Standardize', true ,'ClassNames', [0; 1]);
KernpartitionedModel05 = crossval(KernelCVSVMModel05, 'KFold', 10);
KernpartitionedModel05.Trained{1};
klabel05 = predict( KernpartitionedModel05.Trained{1},TLest_data05(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel06= fitcsvm(TLrain_data06(:,1:16),TLrain_data06(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1,  'BoxConstraint',1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel06 = crossval(KernelCVSVMModel06, 'KFold', 10);
KernpartitionedModel06.Trained{1};
klabel06 = predict( KernpartitionedModel06.Trained{1},TLest_data06(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel07= fitcsvm(TLrain_data07(:,1:16),TLrain_data07(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel07 = crossval(KernelCVSVMModel07, 'KFold', 10);
KernpartitionedModel07.Trained{1};
klabel07 = predict( KernpartitionedModel07.Trained{1},TLest_data07(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel08= fitcsvm(TLrain_data08(:,1:16),TLrain_data08(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1 ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel08 = crossval(KernelCVSVMModel08, 'KFold', 10);
KernpartitionedModel08.Trained{1};
klabel08 = predict( KernpartitionedModel08.Trained{1},TLest_data08(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel09= fitcsvm(TLrain_data09(:,1:16),TLrain_data09(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel09 = crossval(KernelCVSVMModel09, 'KFold', 10);
KernpartitionedModel09.Trained{1};
klabel09 = predict( KernpartitionedModel09.Trained{1},TLest_data09(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel10= fitcsvm(TLrain_data10(:,1:16),TLrain_data10(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint',  1.1522   ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel10 = crossval(KernelCVSVMModel10, 'KFold', 10);
KernpartitionedModel10.Trained{1};
klabel10 = predict( KernpartitionedModel10.Trained{1},TLest_data10(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel11= fitcsvm(TLrain_data11(:,1:16),TLrain_data11(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1 ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel11 = crossval(KernelCVSVMModel11, 'KFold', 10);
KernpartitionedModel11.Trained{1};
klabel11 = predict( KernpartitionedModel11.Trained{1},TLest_data11(:,1:16));
...
%%
KernelCVSVMModel12= fitcsvm(TLrain_data12(:,1:16),TLrain_data12(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1  ,  'BoxConstraint',   1.1522   ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel12 = crossval(KernelCVSVMModel12, 'KFold', 10);
KernpartitionedModel12.Trained{1};
klabel12 = predict( KernpartitionedModel12.Trained{1},TLest_data12(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel13= fitcsvm(TLrain_data13(:,1:16),TLrain_data13(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint', 1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel13 = crossval(KernelCVSVMModel13, 'KFold', 10);
KernpartitionedModel13.Trained{1};
klabel13 = predict( KernpartitionedModel13.Trained{1},TLest_data13(:,1:16));
%%
...
%%
KernelCVSVMModel14= fitcsvm(TLrain_data14(:,1:16),TLrain_data14(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint' , 1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel14 = crossval(KernelCVSVMModel14, 'KFold', 10);
KernpartitionedModel14.Trained{1};
klabel14 = predict( KernpartitionedModel14.Trained{1},TLest_data14(:,1:16));
%%
...
%%
KernelCVSVMModel15= fitcsvm(TLrain_data15(:,1:16),TLrain_data15(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel15 = crossval(KernelCVSVMModel15, 'KFold', 10);
KernpartitionedModel15.Trained{1};
klabel15 = predict( KernpartitionedModel15.Trained{1},TLest_data15(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel16= fitcsvm(TLrain_data16(:,1:16),TLrain_data16(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1  ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel16 = crossval(KernelCVSVMModel16, 'KFold', 10);
KernpartitionedModel16.Trained{1};
klabel16 = predict( KernpartitionedModel16.Trained{1},TLest_data16(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel17= fitcsvm(TLrain_data17(:,1:16),TLrain_data17(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1 ,  'BoxConstraint',   1.1522    ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel17 = crossval(KernelCVSVMModel17, 'KFold', 10);
KernpartitionedModel17.Trained{1};
klabel17 = predict( KernpartitionedModel17.Trained{1},TLest_data17(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel18= fitcsvm(TLrain_data18(:,1:16),TLrain_data18(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1   ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel18 = crossval(KernelCVSVMModel18, 'KFold', 10);
KernpartitionedModel18.Trained{1};
klabel18 = predict( KernpartitionedModel18.Trained{1},TLest_data18(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel19= fitcsvm(TLrain_data19(:,1:16),TLrain_data19(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1,  'BoxConstraint',1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel19 = crossval(KernelCVSVMModel19, 'KFold', 10);
KernpartitionedModel19.Trained{1};
klabel19 = predict( KernpartitionedModel19.Trained{1},TLest_data19(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel20= fitcsvm(TLrain_data20(:,1:16),TLrain_data20(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint',1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel20= crossval(KernelCVSVMModel20, 'KFold', 10);
KernpartitionedModel20.Trained{1};
klabel20 = predict( KernpartitionedModel20.Trained{1},TLest_data20(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel21= fitcsvm(TLrain_data21(:,1:16),TLrain_data21(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1  ,  'BoxConstraint',1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel21= crossval(KernelCVSVMModel21, 'KFold', 10);
KernpartitionedModel21.Trained{1};
klabel21 = predict( KernpartitionedModel21.Trained{1},TLest_data21(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel22= fitcsvm(TLrain_data22(:,1:16),TLrain_data22(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1   ,  'BoxConstraint', 1.1522    ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel22= crossval(KernelCVSVMModel22, 'KFold', 10);
KernpartitionedModel22.Trained{1};
klabel22 = predict( KernpartitionedModel22.Trained{1},TLest_data22(:,1:16));
%%
...
%%
KernelCVSVMModel23= fitcsvm(TLrain_data23(:,1:16),TLrain_data23(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel23= crossval(KernelCVSVMModel23, 'KFold', 10);
KernpartitionedModel23.Trained{1};
klabel23 = predict( KernpartitionedModel23.Trained{1},TLest_data23(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel24= fitcsvm(TLrain_data24(:,1:16),TLrain_data24(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1 ,  'BoxConstraint',  1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel24= crossval(KernelCVSVMModel24, 'KFold', 10);
KernpartitionedModel24.Trained{1};
klabel24 = predict( KernpartitionedModel24.Trained{1},TLest_data24(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel25= fitcsvm(TLrain_data25(:,1:16),TLrain_data25(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',   1  ,  'BoxConstraint', 1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel25= crossval(KernelCVSVMModel25, 'KFold', 10);
KernpartitionedModel25.Trained{1};
klabel25 = predict( KernpartitionedModel25.Trained{1},TLest_data25(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel26= fitcsvm(TLrain_data26(:,1:16),TLrain_data26(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint', 1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel26= crossval(KernelCVSVMModel26, 'KFold', 10);
KernpartitionedModel26.Trained{1};
klabel26 = predict( KernpartitionedModel26.Trained{1},TLest_data26(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel27= fitcsvm(TLrain_data27(:,1:16),TLrain_data27(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint',1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel27= crossval(KernelCVSVMModel27, 'KFold', 10);
KernpartitionedModel27.Trained{1};
klabel27 = predict( KernpartitionedModel27.Trained{1},TLest_data27(:,1:16));
%%
for i=1:81
...
%%
KernelCVSVMModel28= fitcsvm(TLrain_data28(:,1:16),TLrain_data28(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',   1   ,  'BoxConstraint', 1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel28= crossval(KernelCVSVMModel28, 'KFold', 10);
KernpartitionedModel28.Trained{1};
klabel28 = predict( KernpartitionedModel28.Trained{1},TLest_data28(:,1:16));
%%
...
%%
KernelCVSVMModel29= fitcsvm(TLrain_data29(:,1:16),TLrain_data29(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel29= crossval(KernelCVSVMModel29, 'KFold', 10);
KernpartitionedModel29.Trained{1};
klabel29 = predict( KernpartitionedModel29.Trained{1},TLest_data29(:,1:16));
%%
...
%%
KernelCVSVMModel30= fitcsvm(TLrain_data30(:,1:16),TLrain_data30(:,17), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1 ,  'BoxConstraint', 1.1522   ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel30= crossval(KernelCVSVMModel30, 'KFold', 10);
KernpartitionedModel30.Trained{1};
klabel30 = predict( KernpartitionedModel30.Trained{1},TLest_data30(:,1:16));
