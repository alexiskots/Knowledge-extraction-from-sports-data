...
%%
KernpartitionedModel01 = fitcsvm(TLrain_data01(:,1:32),TLrain_data01(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1,  'BoxConstraint',1.1522,'Standardize',true,'ClassNames', [0; 1]);
KernpartitionedModel01 = crossval(KernpartitionedModel01, 'KFold', 10);
KernpartitionedModel01.Trained{1};
klabel01 = predict( KernpartitionedModel01.Trained{1},TLest_data01(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel02 = fitcsvm(TLrain_data02(:,1:32),TLrain_data02(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint',  1.1522,'Standardize', true ,'ClassNames', [0; 1]);
KernpartitionedModel02 = crossval(KernpartitionedModel02, 'KFold', 10);
KernpartitionedModel02.Trained{1};
klabel02 = predict( KernpartitionedModel02.Trained{1},TLest_data02(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel03= fitcsvm(TLrain_data03(:,1:32),TLrain_data03(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel03 = crossval(KernpartitionedModel03, 'KFold', 10);
KernpartitionedModel03.Trained{1};
klabel03 = predict( KernpartitionedModel03.Trained{1},TLest_data03(:,1:32 ));
%%
...
%%
KernpartitionedModel04= fitcsvm(TLrain_data04(:,1:32),TLrain_data04(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel04 = crossval(KernpartitionedModel04, 'KFold', 10);
KernpartitionedModel04.Trained{1};
klabel04 = predict( KernpartitionedModel04.Trained{1},TLest_data04(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel05= fitcsvm(TLrain_data05(:,1:32),TLrain_data05(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1,  'BoxConstraint', 1.1522,'Standardize', true ,'ClassNames', [0; 1]);
KernpartitionedModel05 = crossval(KernpartitionedModel05, 'KFold', 10);
KernpartitionedModel05.Trained{1};
klabel05 = predict( KernpartitionedModel05.Trained{1},TLest_data05(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel06= fitcsvm(TLrain_data06(:,1:32),TLrain_data06(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1,  'BoxConstraint',1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel06 = crossval(KernpartitionedModel06, 'KFold', 10);
KernpartitionedModel06.Trained{1};
klabel06 = predict( KernpartitionedModel06.Trained{1},TLest_data06(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel07= fitcsvm(TLrain_data07(:,1:32),TLrain_data07(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel07 = crossval(KernpartitionedModel07, 'KFold', 10);
KernpartitionedModel07.Trained{1};
klabel07 = predict( KernpartitionedModel07.Trained{1},TLest_data07(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel08= fitcsvm(TLrain_data08(:,1:32),TLrain_data08(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1 ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel08 = crossval(KernpartitionedModel08, 'KFold', 10);
KernpartitionedModel08.Trained{1};
klabel08 = predict( KernpartitionedModel08.Trained{1},TLest_data08(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel09= fitcsvm(TLrain_data09(:,1:32),TLrain_data09(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel09 = crossval(KernpartitionedModel09, 'KFold', 10);
KernpartitionedModel09.Trained{1};
klabel09 = predict( KernpartitionedModel09.Trained{1},TLest_data09(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel10= fitcsvm(TLrain_data10(:,1:32),TLrain_data10(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint',  1.1522   ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel10 = crossval(KernpartitionedModel10, 'KFold', 10);
KernpartitionedModel10.Trained{1};
klabel10 = predict( KernpartitionedModel10.Trained{1},TLest_data10(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel11= fitcsvm(TLrain_data11(:,1:32),TLrain_data11(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1 ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel11 = crossval(KernpartitionedModel11, 'KFold', 10);
KernpartitionedModel11.Trained{1};
klabel11 = predict( KernpartitionedModel11.Trained{1},TLest_data11(:,1:32 ));
...
%%
KernpartitionedModel12= fitcsvm(TLrain_data12(:,1:32),TLrain_data12(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1  ,  'BoxConstraint',   1.1522   ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel12 = crossval(KernpartitionedModel12, 'KFold', 10);
KernpartitionedModel12.Trained{1};
klabel12 = predict( KernpartitionedModel12.Trained{1},TLest_data12(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel13= fitcsvm(TLrain_data13(:,1:32),TLrain_data13(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint', 1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel13 = crossval(KernpartitionedModel13, 'KFold', 10);
KernpartitionedModel13.Trained{1};
klabel13 = predict( KernpartitionedModel13.Trained{1},TLest_data13(:,1:32 ));
%%
...
%%
KernpartitionedModel14= fitcsvm(TLrain_data14(:,1:32),TLrain_data14(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint' , 1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel14 = crossval(KernpartitionedModel14, 'KFold', 10);
KernpartitionedModel14.Trained{1};
klabel14 = predict( KernpartitionedModel14.Trained{1},TLest_data14(:,1:32 ));
%%
...
%%
KernpartitionedModel15= fitcsvm(TLrain_data15(:,1:32),TLrain_data15(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel15 = crossval(KernpartitionedModel15, 'KFold', 10);
KernpartitionedModel15.Trained{1};
klabel15 = predict( KernpartitionedModel15.Trained{1},TLest_data15(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel16= fitcsvm(TLrain_data16(:,1:32),TLrain_data16(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1  ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel16 = crossval(KernpartitionedModel16, 'KFold', 10);
KernpartitionedModel16.Trained{1};
klabel16 = predict( KernpartitionedModel16.Trained{1},TLest_data16(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel17= fitcsvm(TLrain_data17(:,1:32),TLrain_data17(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1 ,  'BoxConstraint',   1.1522    ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel17 = crossval(KernpartitionedModel17, 'KFold', 10);
KernpartitionedModel17.Trained{1};
klabel17 = predict( KernpartitionedModel17.Trained{1},TLest_data17(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel18= fitcsvm(TLrain_data18(:,1:32),TLrain_data18(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1   ,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel18 = crossval(KernpartitionedModel18, 'KFold', 10);
KernpartitionedModel18.Trained{1};
klabel18 = predict( KernpartitionedModel18.Trained{1},TLest_data18(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel19= fitcsvm(TLrain_data19(:,1:32),TLrain_data19(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1,  'BoxConstraint',1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel19 = crossval(KernpartitionedModel19, 'KFold', 10);
KernpartitionedModel19.Trained{1};
klabel19 = predict( KernpartitionedModel19.Trained{1},TLest_data19(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel20= fitcsvm(TLrain_data20(:,1:32),TLrain_data20(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint',1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel20= crossval(KernpartitionedModel20, 'KFold', 10);
KernpartitionedModel20.Trained{1};
klabel20 = predict( KernpartitionedModel20.Trained{1},TLest_data20(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel21= fitcsvm(TLrain_data21(:,1:32),TLrain_data21(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1  ,  'BoxConstraint',1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel21= crossval(KernpartitionedModel21, 'KFold', 10);
KernpartitionedModel21.Trained{1};
klabel21 = predict( KernpartitionedModel21.Trained{1},TLest_data21(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel22= fitcsvm(TLrain_data22(:,1:32),TLrain_data22(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1   ,  'BoxConstraint', 1.1522    ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel22= crossval(KernpartitionedModel22, 'KFold', 10);
KernpartitionedModel22.Trained{1};
klabel22 = predict( KernpartitionedModel22.Trained{1},TLest_data22(:,1:32 ));
%%
...
%%
KernpartitionedModel23= fitcsvm(TLrain_data23(:,1:32),TLrain_data23(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1  ,  'BoxConstraint',  1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel23= crossval(KernpartitionedModel23, 'KFold', 10);
KernpartitionedModel23.Trained{1};
klabel23 = predict( KernpartitionedModel23.Trained{1},TLest_data23(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel24= fitcsvm(TLrain_data24(:,1:32),TLrain_data24(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',  1 ,  'BoxConstraint',  1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel24= crossval(KernpartitionedModel24, 'KFold', 10);
KernpartitionedModel24.Trained{1};
klabel24 = predict( KernpartitionedModel24.Trained{1},TLest_data24(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel25= fitcsvm(TLrain_data25(:,1:32),TLrain_data25(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',   1  ,  'BoxConstraint', 1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel25= crossval(KernpartitionedModel25, 'KFold', 10);
KernpartitionedModel25.Trained{1};
klabel25 = predict( KernpartitionedModel25.Trained{1},TLest_data25(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel26= fitcsvm(TLrain_data26(:,1:32),TLrain_data26(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint', 1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel26= crossval(KernpartitionedModel26, 'KFold', 10);
KernpartitionedModel26.Trained{1};
klabel26 = predict( KernpartitionedModel26.Trained{1},TLest_data26(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel27= fitcsvm(TLrain_data27(:,1:32),TLrain_data27(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1 ,  'BoxConstraint',1.1522,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel27= crossval(KernpartitionedModel27, 'KFold', 10);
KernpartitionedModel27.Trained{1};
klabel27 = predict( KernpartitionedModel27.Trained{1},TLest_data27(:,1:32 ));
%%
for i=1:79
...
%%
KernpartitionedModel28= fitcsvm(TLrain_data28(:,1:32),TLrain_data28(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',   1   ,  'BoxConstraint', 1.1522  ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel28= crossval(KernpartitionedModel28, 'KFold', 10);
KernpartitionedModel28.Trained{1};
klabel28 = predict( KernpartitionedModel28.Trained{1},TLest_data28(:,1:32 ));
%%
...
%%
KernpartitionedModel29= fitcsvm(TLrain_data29(:,1:32),TLrain_data29(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale',1,  'BoxConstraint', 1.1522 ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel29= crossval(KernpartitionedModel29, 'KFold', 10);
KernpartitionedModel29.Trained{1};
klabel29 = predict( KernpartitionedModel29.Trained{1},TLest_data29(:,1:32 ));
%%
...
%%
KernpartitionedModel30= fitcsvm(TLrain_data30(:,1:32),TLrain_data30(:,33), 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 1 ,  'BoxConstraint', 1.1522   ,'Standardize', true,'ClassNames', [0; 1]);
KernpartitionedModel30= crossval(KernpartitionedModel30, 'KFold', 10);
KernpartitionedModel30.Trained{1};
klabel30 = predict( KernpartitionedModel30.Trained{1},TLest_data30(:,1:32 ));