%%for k=5
kconfMatrix01= confusionmat(TLest_data01(:,41),klabel01(:,1));
...
kL01 = loss(KernpartitionedModel01.Trained{1},TLest_data01(:,1:40),TLest_data01(:,41));
kConfusionTest01 = confusionchart(TLest_data01(:,41),klabel01(:,1));
%%
kconfMatrix02= confusionmat(TLest_data02(:,41),klabel02(:,1));
...
kL02 = loss(KernpartitionedModel02.Trained{1},TLest_data02(:,1:40),TLest_data02(:,41));
kConfusionTest02 = confusionchart(TLest_data02(:,41),klabel02(:,1));
%%
kconfMatrix03= confusionmat(TLest_data03(:,41),klabel03(:,1));
...
kL03 = loss(KernpartitionedModel03.Trained{1},TLest_data03(:,1:40),TLest_data03(:,41));
kConfusionTest03 = confusionchart(TLest_data03(:,41),klabel03(:,1));
%%
kconfMatrix04= confusionmat(TLest_data04(:,41),klabel04(:,1));
...
kL04 = loss(KernpartitionedModel04.Trained{1},TLest_data04(:,1:40),TLest_data04(:,41));
kConfusionTest04 = confusionchart(TLest_data04(:,41),klabel04(:,1));
%%
kconfMatrix05= confusionmat(TLest_data05(:,41),klabel05(:,1));
...
kL05 = loss(KernpartitionedModel05.Trained{1},TLest_data05(:,1:40),TLest_data05(:,41));
kConfusionTest05 = confusionchart(TLest_data05(:,41),klabel05(:,1));
%%
kconfMatrix06= confusionmat(TLest_data06(:,41),klabel06(:,1));
...
kL06 = loss(KernpartitionedModel06.Trained{1},TLest_data06(:,1:40),TLest_data06(:,41));
kConfusionTest06 = confusionchart(TLest_data06(:,41),klabel06(:,1));
%%
kconfMatrix07= confusionmat(TLest_data07(:,41),klabel07(:,1));
...
kL07 = loss(KernpartitionedModel07.Trained{1},TLest_data07(:,1:40),TLest_data07(:,41));
kConfusionTest07 = confusionchart(TLest_data07(:,41),klabel07(:,1));
%%
kconfMatrix08= confusionmat(TLest_data08(:,41),klabel08(:,1));
...
kL08 = loss(KernpartitionedModel08.Trained{1},TLest_data08(:,1:40),TLest_data08(:,41));
kConfusionTest08 = confusionchart(TLest_data08(:,41),klabel08(:,1));
%%
kconfMatrix09= confusionmat(TLest_data09(:,41),klabel09(:,1));
...
kL09 = loss(KernpartitionedModel09.Trained{1},TLest_data09(:,1:40),TLest_data09(:,41));
kConfusionTest09 = confusionchart(TLest_data09(:,41),klabel09(:,1));
%%
kconfMatrix10= confusionmat(TLest_data10(:,41),klabel10(:,1));
...
kL10 = loss(KernpartitionedModel10.Trained{1},TLest_data10(:,1:40),TLest_data10(:,41));
kConfusionTest10 = confusionchart(TLest_data10(:,41),klabel10(:,1));
%%
kconfMatrix11= confusionmat(TLest_data11(:,41),klabel11(:,1));
...
kL11 = loss(KernpartitionedModel11.Trained{1},TLest_data11(:,1:40),TLest_data11(:,41));
kConfusionTest11 = confusionchart(TLest_data11(:,41),klabel11(:,1));
%%
kconfMatrix12= confusionmat(TLest_data12(:,41),klabel12(:,1));
...
kL12 = loss(KernpartitionedModel12.Trained{1},TLest_data12(:,1:40),TLest_data12(:,41));
kConfusionTest12 = confusionchart(TLest_data12(:,41),klabel12(:,1));
%%
kconfMatrix13= confusionmat(TLest_data13(:,41),klabel13(:,1));
...
kL13 = loss(KernpartitionedModel13.Trained{1},TLest_data13(:,1:40),TLest_data13(:,41));
kConfusionTest13 = confusionchart(TLest_data13(:,41),klabel13(:,1));
%%
kconfMatrix14= confusionmat(TLest_data14(:,41),klabel14(:,1));
...
kL14 = loss(KernpartitionedModel14.Trained{1},TLest_data14(:,1:40),TLest_data14(:,41));
kConfusionTest14 = confusionchart(TLest_data14(:,41),klabel14(:,1));
%%
kconfMatrix15= confusionmat(TLest_data15(:,41),klabel15(:,1));
...
kL15 = loss(KernpartitionedModel15.Trained{1},TLest_data15(:,1:40),TLest_data15(:,41));
kConfusionTest15 = confusionchart(TLest_data15(:,41),klabel15(:,1));
%%
kconfMatrix16= confusionmat(TLest_data16(:,41),klabel16(:,1));
...
kL16 = loss(KernpartitionedModel16.Trained{1},TLest_data16(:,1:40),TLest_data16(:,41));
kConfusionTest16 = confusionchart(TLest_data16(:,41),klabel16(:,1));
%%
kconfMatrix17= confusionmat(TLest_data17(:,41),klabel17(:,1));
...
kL17 = loss(KernpartitionedModel17.Trained{1},TLest_data17(:,1:40),TLest_data17(:,41));
kConfusionTest17 = confusionchart(TLest_data17(:,41),klabel17(:,1));
%%
kconfMatrix18= confusionmat(TLest_data18(:,41),klabel18(:,1));
...
kL18 = loss(KernpartitionedModel18.Trained{1},TLest_data18(:,1:40),TLest_data18(:,41));
kConfusionTest18 = confusionchart(TLest_data18(:,41),klabel18(:,1));
%%
kconfMatrix19= confusionmat(TLest_data19(:,41),klabel19(:,1));
...
kL19 = loss(KernpartitionedModel19.Trained{1},TLest_data19(:,1:40),TLest_data19(:,41));
kConfusionTest19 = confusionchart(TLest_data19(:,41),klabel19(:,1));
%%
kconfMatrix20= confusionmat(TLest_data20(:,41),klabel20(:,1));
...
kL20 = loss(KernpartitionedModel20.Trained{1},TLest_data20(:,1:40),TLest_data20(:,41));
kConfusionTest20 = confusionchart(TLest_data20(:,41),klabel20(:,1));
%%
kconfMatrix21= confusionmat(TLest_data21(:,41),klabel21(:,1));
...
kL21= loss(KernpartitionedModel21.Trained{1},TLest_data21(:,1:40),TLest_data21(:,41));
kConfusionTest21 = confusionchart(TLest_data21(:,41),klabel21(:,1));
%%
kconfMatrix22= confusionmat(TLest_data22(:,41),klabel22(:,1));
...
kL22= loss(KernpartitionedModel22.Trained{1},TLest_data22(:,1:40),TLest_data22(:,41));
kConfusionTest22 = confusionchart(TLest_data22(:,41),klabel22(:,1));
%%
kconfMatrix23= confusionmat(TLest_data23(:,41),klabel23(:,1));
...
kL23= loss(KernpartitionedModel23.Trained{1},TLest_data23(:,1:40),TLest_data23(:,41));
kConfusionTest23 = confusionchart(TLest_data23(:,41),klabel23(:,1));
%%
kconfMatrix24= confusionmat(TLest_data24(:,41),klabel24(:,1));
...
kL24= loss(KernpartitionedModel24.Trained{1},TLest_data24(:,1:40),TLest_data24(:,41));
kConfusionTest24 = confusionchart(TLest_data24(:,41),klabel24(:,1));
%%
kconfMatrix25= confusionmat(TLest_data25(:,41),klabel25(:,1));
...
kL25= loss(KernpartitionedModel25.Trained{1},TLest_data25(:,1:40),TLest_data25(:,41));
kConfusionTest25 = confusionchart(TLest_data25(:,41),klabel25(:,1));
%%
kconfMatrix26= confusionmat(TLest_data26(:,41),klabel26(:,1));
...
kL26= loss(KernpartitionedModel26.Trained{1},TLest_data26(:,1:40),TLest_data26(:,41));
kConfusionTest26 = confusionchart(TLest_data26(:,41),klabel26(:,1));
%%
kconfMatrix27= confusionmat(TLest_data27(:,41),klabel27(:,1));
...
kL27= loss(KernpartitionedModel27.Trained{1},TLest_data27(:,1:40),TLest_data27(:,41));
kConfusionTest27 = confusionchart(TLest_data27(:,41),klabel27(:,1));
%%
kconfMatrix28= confusionmat(TLest_data28(:,41),klabel28(:,1));
...
kL28= loss(KernpartitionedModel28.Trained{1},TLest_data28(:,1:40),TLest_data28(:,41));
kConfusionTest28 = confusionchart(TLest_data28(:,41),klabel28(:,1));
%%
kconfMatrix29= confusionmat(TLest_data29(:,41),klabel29(:,1));
...
kL29= loss(KernpartitionedModel29.Trained{1},TLest_data29(:,1:40),TLest_data29(:,41));
kConfusionTest29 = confusionchart(TLest_data29(:,41),klabel29(:,1));
%%
kconfMatrix30= confusionmat(TLest_data30(:,41),klabel30(:,1));
...
kL30= loss(KernpartitionedModel30.Trained{1},TLest_data30(:,1:40),TLest_data30(:,41));
kConfusionTest30 = confusionchart(TLest_data30(:,41),klabel30(:,1));
%%
