...
LinearCVSMModel01 =fitclinear(TLrain_data01(:,1:32),TLrain_data01(:,33),'CrossVal','on');
LinearCVSMModel01.Trained{1};
linlabel01 = predict(LinearCVSMModel01.Trained{1} ,TLest_data01(:,1:32));
%%
for i=1:79
...
LinearCVSMModel02 =fitclinear(TLrain_data02(:,1:32),TLrain_data02(:,33),'CrossVal','on');
LinearCVSMModel02.Trained{1};
linlabel02 = predict(LinearCVSMModel02.Trained{1},TLest_data02(:,1:32));
...
LinearCVSMModel03 =fitclinear(TLrain_data03(:,1:32),TLrain_data03(:,33),'CrossVal','on');
LinearCVSMModel03.Trained{1};
linlabel03 = predict(LinearCVSMModel03.Trained{1},TLest_data03(:,1:32));
...
LinearCVSMModel04 =fitclinear(TLrain_data04(:,1:32),TLrain_data04(:,33),'CrossVal','on');
LinearCVSMModel04.Trained{1};
linlabel04 = predict(LinearCVSMModel04.Trained{1},TLest_data04(:,1:32));
...
LinearCVSMModel05 =fitclinear(TLrain_data05(:,1:32),TLrain_data05(:,33),'CrossVal','on');
LinearCVSMModel05.Trained{1};
linlabel05 = predict(LinearCVSMModel05.Trained{1},TLest_data05(:,1:32));
...
LinearCVSMModel06 =fitclinear(TLrain_data06(:,1:32),TLrain_data06(:,33),'CrossVal','on');
LinearCVSMModel06.Trained{1};
linlabel06 = predict(LinearCVSMModel06.Trained{1},TLest_data06(:,1:32));
...
LinearCVSMModel07 =fitclinear(TLrain_data07(:,1:32),TLrain_data07(:,33),'CrossVal','on');
LinearCVSMModel07.Trained{1};
linlabel07= predict(LinearCVSMModel07.Trained{1},TLest_data07(:,1:32));
...
LinearCVSMModel08 =fitclinear(TLrain_data08(:,1:32),TLrain_data08(:,33),'CrossVal','on');
LinearCVSMModel08.Trained{1};
linlabel08= predict(LinearCVSMModel08.Trained{1},TLest_data08(:,1:32));
...
LinearCVSMModel09 =fitclinear(TLrain_data09(:,1:32),TLrain_data09(:,33),'CrossVal','on');
LinearCVSMModel09.Trained{1};
linlabel09= predict(LinearCVSMModel09.Trained{1},TLest_data09(:,1:32));
...
LinearCVSMModel10 =fitclinear(TLrain_data10(:,1:32),TLrain_data10(:,33),'CrossVal','on');
LinearCVSMModel10.Trained{1};
linlabel10 = predict(LinearCVSMModel10.Trained{1},TLest_data10(:,1:32));
...
LinearCVSMModel11 =fitclinear(TLrain_data11(:,1:32),TLrain_data11(:,33),'CrossVal','on');
LinearCVSMModel11.Trained{1};
linlabel11 = predict(LinearCVSMModel11.Trained{1},TLest_data11(:,1:32));
...
LinearCVSMModel12 =fitclinear(TLrain_data12(:,1:32),TLrain_data12(:,33),'CrossVal','on');
LinearCVSMModel12.Trained{1};
linlabel12 = predict(LinearCVSMModel12.Trained{1},TLest_data12(:,1:32));
...
LinearCVSMModel13 =fitclinear(TLrain_data13(:,1:32),TLrain_data13(:,33),'CrossVal','on');
LinearCVSMModel13.Trained{1};
linlabel13 = predict(LinearCVSMModel13.Trained{1},TLest_data13(:,1:32));
...
LinearCVSMModel14 =fitclinear(TLrain_data14(:,1:32),TLrain_data14(:,33),'CrossVal','on');
LinearCVSMModel14.Trained{1};
linlabel14= predict(LinearCVSMModel14.Trained{1},TLest_data14(:,1:32));
...
LinearCVSMModel15 =fitclinear(TLrain_data15(:,1:32),TLrain_data15(:,33),'CrossVal','on');
LinearCVSMModel15.Trained{1};
linlabel15 = predict(LinearCVSMModel15.Trained{1},TLest_data15(:,1:32));
...
LinearCVSMModel16 =fitclinear(TLrain_data16(:,1:32),TLrain_data16(:,33),'CrossVal','on');
LinearCVSMModel16.Trained{1};
linlabel16 = predict(LinearCVSMModel16.Trained{1},TLest_data16(:,1:32));
...
LinearCVSMModel17 =fitclinear(TLrain_data17(:,1:32),TLrain_data17(:,33),'CrossVal','on');
LinearCVSMModel17.Trained{1};
linlabel17 = predict(LinearCVSMModel17.Trained{1},TLest_data17(:,1:32));
...
LinearCVSMModel18 =fitclinear(TLrain_data18(:,1:32),TLrain_data18(:,33),'CrossVal','on');
LinearCVSMModel18.Trained{1};
[linlabel18,kscore18] = predict(LinearCVSMModel18.Trained{1},TLest_data18(:,1:32));
...
LinearCVSMModel19 =fitclinear(TLrain_data19(:,1:32),TLrain_data19(:,33),'CrossVal','on');
LinearCVSMModel19.Trained{1};
linlabel19 = predict(LinearCVSMModel19.Trained{1},TLest_data19(:,1:32));
...
LinearCVSMModel20 =fitclinear(TLrain_data20(:,1:32),TLrain_data20(:,33),'CrossVal','on');
LinearCVSMModel20.Trained{1};
linlabel20= predict(LinearCVSMModel20.Trained{1},TLest_data20(:,1:32));
...
LinearCVSMModel21 =fitclinear(TLrain_data21(:,1:32),TLrain_data21(:,33),'CrossVal','on');
LinearCVSMModel21.Trained{1};
linlabel21 = predict(LinearCVSMModel21.Trained{1},TLest_data21(:,1:32));
...
LinearCVSMModel22 =fitclinear(TLrain_data22(:,1:32),TLrain_data22(:,33),'CrossVal','on');
LinearCVSMModel22.Trained{1};
linlabel22 = predict(LinearCVSMModel22.Trained{1},TLest_data22(:,1:32));
...
LinearCVSMModel23 =fitclinear(TLrain_data23(:,1:32),TLrain_data23(:,33),'CrossVal','on');
LinearCVSMModel23.Trained{1};
linlabel23 = predict(LinearCVSMModel23.Trained{1},TLest_data23(:,1:32));
...
LinearCVSMModel24 =fitclinear(TLrain_data24(:,1:32),TLrain_data24(:,33),'CrossVal','on');
LinearCVSMModel24.Trained{1};
linlabel24= predict(LinearCVSMModel24.Trained{1},TLest_data24(:,1:32));
...
LinearCVSMModel25 =fitclinear(TLrain_data25(:,1:32),TLrain_data25(:,33),'CrossVal','on');
LinearCVSMModel25.Trained{1};
linlabel25 = predict(LinearCVSMModel25.Trained{1},TLest_data25(:,1:32));
...
LinearCVSMModel26 =fitclinear(TLrain_data26(:,1:32),TLrain_data26(:,33),'CrossVal','on');
LinearCVSMModel26.Trained{1};
linlabel26= predict(LinearCVSMModel26.Trained{1},TLest_data26(:,1:32));
...
LinearCVSMModel27 =fitclinear(TLrain_data27(:,1:32),TLrain_data27(:,33),'CrossVal','on');
LinearCVSMModel27.Trained{1};
linlabel27 = predict(LinearCVSMModel27.Trained{1},TLest_data27(:,1:32));
...
LinearCVSMModel28 =fitclinear(TLrain_data28(:,1:32),TLrain_data28(:,33),'CrossVal','on');
LinearCVSMModel28.Trained{1};
linlabel28= predict(LinearCVSMModel28.Trained{1},TLest_data28(:,1:32));
...
LinearCVSMModel29 =fitclinear(TLrain_data29(:,1:32),TLrain_data29(:,33),'CrossVal','on');
LinearCVSMModel29.Trained{1};
linlabel29 = predict(LinearCVSMModel29.Trained{1},TLest_data29(:,1:32));
...
LinearCVSMModel30 =fitclinear(TLrain_data30(:,1:32),TLrain_data30(:,33),'CrossVal','on');
LinearCVSMModel30.Trained{1};
linlabel30= predict(LinearCVSMModel30.Trained{1},TLest_data30(:,1:32));