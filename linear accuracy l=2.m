%% recal linear class l =2
L01= loss(LinearCVSMModel01.Trained{1},TLest_data01(:,1:16),TLest_data01(:,17));
ConfusionTest01= confusionchart(TLest_data01(:,17),linlabel01(:,1));
confMatrix01= confusionmat(TLest_data01(:,17),linlabel01(:,1));
...
%%
L02= loss(LinearCVSMModel02.Trained{1},TLest_data02(:,1:16),TLest_data02(:,17));
ConfusionTest02= confusionchart(TLest_data02(:,17),linlabel02(:,1));
confMatrix02= confusionmat(TLest_data02(:,17),linlabel02(:,1));
...
%%
L03= loss(LinearCVSMModel03.Trained{1},TLest_data03(:,1:16),TLest_data03(:,17));
ConfusionTest03= confusionchart(TLest_data03(:,17),linlabel03(:,1));
confMatrix03= confusionmat(TLest_data03(:,17),linlabel03(:,1));
...
%%
L04= loss(LinearCVSMModel04.Trained{1},TLest_data04(:,1:16),TLest_data04(:,17));
ConfusionTest04= confusionchart(TLest_data04(:,17),linlabel04(:,1));
confMatrix04= confusionmat(TLest_data04(:,17),linlabel04(:,1));
...
%%
L05= loss(LinearCVSMModel05.Trained{1},TLest_data05(:,1:16),TLest_data05(:,17));
ConfusionTest05= confusionchart(TLest_data05(:,17),linlabel05(:,1));
confMatrix05= confusionmat(TLest_data05(:,17),linlabel05(:,1));
...
%%
L06= loss(LinearCVSMModel06.Trained{1},TLest_data06(:,1:16),TLest_data06(:,17));
ConfusionTest06= confusionchart(TLest_data06(:,17),linlabel06(:,1));
confMatrix06= confusionmat(TLest_data06(:,17),linlabel06(:,1));
...
%%
L07= loss(LinearCVSMModel07.Trained{1},TLest_data07(:,1:16),TLest_data07(:,17));
ConfusionTest07= confusionchart(TLest_data07(:,17),linlabel07(:,1));
confMatrix07= confusionmat(TLest_data07(:,17),linlabel07(:,1));
...
%%
L08= loss(LinearCVSMModel08.Trained{1},TLest_data08(:,1:16),TLest_data08(:,17));
ConfusionTest08= confusionchart(TLest_data08(:,17),linlabel08(:,1));
confMatrix08= confusionmat(TLest_data08(:,17),linlabel08(:,1));
...
%%
L09= loss(LinearCVSMModel09.Trained{1},TLest_data09(:,1:16),TLest_data09(:,17));
ConfusionTest09= confusionchart(TLest_data09(:,17),linlabel09(:,1));
confMatrix09 = confusionmat(TLest_data09(:,17),linlabel09(:,1));
...
%%
L10= loss(LinearCVSMModel10.Trained{1},TLest_data10(:,1:16),TLest_data10(:,17));
ConfusionTest10= confusionchart(TLest_data10(:,17),linlabel10(:,1));
confMatrix10 = confusionmat(TLest_data10(:,17),linlabel10(:,1));
...
%%
L11= loss(LinearCVSMModel11.Trained{1},TLest_data11(:,1:16),TLest_data11(:,17));
ConfusionTest11= confusionchart(TLest_data11(:,17),linlabel11(:,1));
confMatrix11 = confusionmat(TLest_data11(:,17),linlabel11(:,1));
...
%%
L12= loss(LinearCVSMModel12.Trained{1},TLest_data12(:,1:16),TLest_data12(:,17));
ConfusionTest12= confusionchart(TLest_data12(:,17),linlabel12(:,1));
confMatrix12 = confusionmat(TLest_data12(:,17),linlabel12(:,1));
...
%%
L13= loss(LinearCVSMModel13.Trained{1},TLest_data13(:,1:16),TLest_data13(:,17));
ConfusionTest13= confusionchart(TLest_data13(:,17),linlabel13(:,1));
confMatrix13 = confusionmat(TLest_data13(:,17),linlabel13(:,1));
...
%%
L14= loss(LinearCVSMModel14.Trained{1},TLest_data14(:,1:16),TLest_data14(:,17));
ConfusionTest14= confusionchart(TLest_data14(:,17),linlabel14(:,1));
confMatrix14 = confusionmat(TLest_data14(:,17),linlabel14(:,1));
...
%%
L15= loss(LinearCVSMModel15.Trained{1},TLest_data15(:,1:16),TLest_data15(:,17));
ConfusionTest15= confusionchart(TLest_data15(:,17),linlabel15(:,1));
confMatrix15 = confusionmat(TLest_data15(:,17),linlabel15(:,1));
...
%%
L16= loss(LinearCVSMModel16.Trained{1},TLest_data16(:,1:16),TLest_data16(:,17));
ConfusionTest16= confusionchart(TLest_data16(:,17),linlabel16(:,1));
confMatrix16 = confusionmat(TLest_data16(:,17),linlabel16(:,1));
...
%%
L17= loss(LinearCVSMModel17.Trained{1},TLest_data17(:,1:16),TLest_data17(:,17));
ConfusionTest17= confusionchart(TLest_data17(:,17),linlabel17(:,1));
confMatrix17 = confusionmat(TLest_data17(:,17),linlabel17(:,1));
...
%%
L18= loss(LinearCVSMModel18.Trained{1},TLest_data18(:,1:16),TLest_data18(:,17));
ConfusionTest18= confusionchart(TLest_data18(:,17),linlabel18(:,1));
confMatrix18 = confusionmat(TLest_data18(:,17),linlabel18(:,1));
...
%%
L19= loss(LinearCVSMModel19.Trained{1},TLest_data19(:,1:16),TLest_data19(:,17));
ConfusionTest19= confusionchart(TLest_data19(:,17),linlabel19(:,1));
confMatrix19 = confusionmat(TLest_data19(:,17),linlabel19(:,1));
...
%%
L20= loss(LinearCVSMModel20.Trained{1},TLest_data20(:,1:16),TLest_data20(:,17));
ConfusionTest20= confusionchart(TLest_data20(:,17),linlabel20(:,1));
confMatrix20 = confusionmat(TLest_data20(:,17),linlabel20(:,1));
...
%%
L21 = loss(LinearCVSMModel21.Trained{1},TLest_data21(:,1:16),TLest_data21(:,17));
ConfusionTest21= confusionchart(TLest_data21(:,17),linlabel21(:,1));
confMatrix21 = confusionmat(TLest_data21(:,17),linlabel21(:,1));
...
%%
L22 = loss(LinearCVSMModel22.Trained{1},TLest_data22(:,1:16),TLest_data22(:,17));
ConfusionTest22= confusionchart(TLest_data22(:,17),linlabel22(:,1));
confMatrix22 = confusionmat(TLest_data22(:,17),linlabel22(:,1));
...
%%
L23 = loss(LinearCVSMModel23.Trained{1},TLest_data23(:,1:16),TLest_data23(:,17));
ConfusionTest23= confusionchart(TLest_data23(:,17),linlabel23(:,1));
confMatrix23 = confusionmat(TLest_data23(:,17),linlabel23(:,1));
...
%%
L24 = loss(LinearCVSMModel24.Trained{1},TLest_data24(:,1:16),TLest_data24(:,17));
ConfusionTest24= confusionchart(TLest_data24(:,17),linlabel24(:,1));
confMatrix24 = confusionmat(TLest_data24(:,17),linlabel24(:,1));
...
%%
L25 = loss(LinearCVSMModel25.Trained{1},TLest_data25(:,1:16),TLest_data25(:,17));
ConfusionTest25= confusionchart(TLest_data25(:,17),linlabel25(:,1));
confMatrix25 = confusionmat(TLest_data25(:,17),linlabel25(:,1));
...
%%
L26 = loss(LinearCVSMModel26.Trained{1},TLest_data26(:,1:16),TLest_data26(:,17));
ConfusionTest26= confusionchart(TLest_data26(:,17),linlabel26(:,1));
confMatrix26 = confusionmat(TLest_data26(:,17),linlabel26(:,1));
...
%%
L27 = loss(LinearCVSMModel27.Trained{1},TLest_data27(:,1:16),TLest_data27(:,17));
ConfusionTest27= confusionchart(TLest_data27(:,17),linlabel27(:,1));
confMatrix27 = confusionmat(TLest_data27(:,17),linlabel27(:,1));
...
%%
L28 = loss(LinearCVSMModel28.Trained{1},TLest_data28(:,1:16),TLest_data28(:,17));
ConfusionTest28= confusionchart(TLest_data28(:,17),linlabel28(:,1));
confMatrix28 = confusionmat(TLest_data28(:,17),linlabel28(:,1));
...
%%
L29 = loss(LinearCVSMModel29.Trained{1},TLest_data29(:,1:16),TLest_data29(:,17));
ConfusionTest29= confusionchart(TLest_data29(:,17),linlabel29(:,1));
confMatrix29 = confusionmat(TLest_data29(:,17),linlabel29(:,1));
...
%%
L30 = loss(LinearCVSMModel30.Trained{1},TLest_data30(:,1:16),TLest_data30(:,17));
ConfusionTest30= confusionchart(TLest_data30(:,17),linlabel30(:,1));
confMatrix30 = confusionmat(TLest_data30(:,17),linlabel30(:,1));
