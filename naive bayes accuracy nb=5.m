%% for nb=5
nbconfMatrix01= confusionmat(TLest_data01(:,41),nblabel01(:,1));
...
nbL01 = loss(parNaveBayesModel01.Trained{1},TLest_data01(:,1:40),TLest_data01(:,41));
nbConfusionTest01 = confusionchart(TLest_data01(:,41),nblabel01(:,1));

%%
nbconfMatrix02= confusionmat(TLest_data02(:,41),nblabel02(:,1));
...
nbL02 = loss(parNaveBayesModel02.Trained{1},TLest_data02(:,1:40),TLest_data02(:,41));
nbConfusionTest02 = confusionchart(TLest_data02(:,41),nblabel02(:,1));
%%
nbconfMatrix03= confusionmat(TLest_data03(:,41),nblabel03(:,1));
...
nbL03 = loss(parNaveBayesModel03.Trained{1},TLest_data03(:,1:40),TLest_data03(:,41));
nbConfusionTest03 = confusionchart(TLest_data03(:,41),nblabel03(:,1));
%%
nbconfMatrix04= confusionmat(TLest_data04(:,41),nblabel04(:,1));
...
nbL04 = loss(parNaveBayesModel04.Trained{1},TLest_data04(:,1:40),TLest_data04(:,41));
nbConfusionTest04 = confusionchart(TLest_data04(:,41),nblabel04(:,1));
%%
nbconfMatrix05= confusionmat(TLest_data05(:,41),nblabel05(:,1));
...
nbL05 = loss(parNaveBayesModel05.Trained{1},TLest_data05(:,1:40),TLest_data05(:,41));
nbConfusionTest05 = confusionchart(TLest_data05(:,41),nblabel05(:,1));
%%
nbconfMatrix06= confusionmat(TLest_data06(:,41),nblabel06(:,1));
...
nbL06 = loss(parNaveBayesModel06.Trained{1},TLest_data06(:,1:40),TLest_data06(:,41));
nbConfusionTest06 = confusionchart(TLest_data06(:,41),nblabel06(:,1));
%%
nbconfMatrix07= confusionmat(TLest_data07(:,41),nblabel07(:,1));
...
nbL07 = loss(parNaveBayesModel07.Trained{1},TLest_data07(:,1:40),TLest_data07(:,41));
nbConfusionTest07 = confusionchart(TLest_data07(:,41),nblabel07(:,1));
%%
nbconfMatrix08= confusionmat(TLest_data08(:,41),nblabel08(:,1));
...
nbL08 = loss(parNaveBayesModel08.Trained{1},TLest_data08(:,1:40),TLest_data08(:,41));
nbConfusionTest08 = confusionchart(TLest_data08(:,41),nblabel08(:,1));
%%
nbconfMatrix09= confusionmat(TLest_data09(:,41),nblabel09(:,1));
...
nbL09 = loss(parNaveBayesModel09.Trained{1},TLest_data09(:,1:40),TLest_data09(:,41));
nbConfusionTest09 = confusionchart(TLest_data09(:,41),nblabel09(:,1));
%%
nbconfMatrix10= confusionmat(TLest_data10(:,41),nblabel10(:,1));
...
nbL10 = loss(parNaveBayesModel10.Trained{1},TLest_data10(:,1:40),TLest_data10(:,41));
nbConfusionTest10 = confusionchart(TLest_data10(:,41),nblabel10(:,1));
%%
nbconfMatrix11= confusionmat(TLest_data11(:,41),nblabel11(:,1));
...
nbL11 = loss(parNaveBayesModel11.Trained{1},TLest_data11(:,1:40),TLest_data11(:,41));
nbConfusionTest11 = confusionchart(TLest_data11(:,41),nblabel11(:,1));
%%
nbconfMatrix12= confusionmat(TLest_data12(:,41),nblabel12(:,1));
...
nbL12 = loss(parNaveBayesModel12.Trained{1},TLest_data12(:,1:40),TLest_data12(:,41));
nbConfusionTest12 = confusionchart(TLest_data12(:,41),nblabel12(:,1));
%%
nbconfMatrix13= confusionmat(TLest_data13(:,41),nblabel13(:,1));
...
nbL13 = loss(parNaveBayesModel13.Trained{1},TLest_data13(:,1:40),TLest_data13(:,41));
nbConfusionTest13 = confusionchart(TLest_data13(:,41),nblabel13(:,1));
%%
nbconfMatrix14= confusionmat(TLest_data14(:,41),nblabel14(:,1));
...
nbL14 = loss(parNaveBayesModel14.Trained{1},TLest_data14(:,1:40),TLest_data14(:,41));
nbConfusionTest14 = confusionchart(TLest_data14(:,41),nblabel14(:,1));
%%
nbconfMatrix15= confusionmat(TLest_data15(:,41),nblabel15(:,1));
...
nbL15 = loss(parNaveBayesModel15.Trained{1},TLest_data15(:,1:40),TLest_data15(:,41));
nbConfusionTest15 = confusionchart(TLest_data15(:,41),nblabel15(:,1));
%%
nbconfMatrix16= confusionmat(TLest_data16(:,41),nblabel16(:,1));
...
nbL16 = loss(parNaveBayesModel16.Trained{1},TLest_data16(:,1:40),TLest_data16(:,41));
nbConfusionTest16 = confusionchart(TLest_data16(:,41),nblabel16(:,1));
%%
nbconfMatrix17= confusionmat(TLest_data17(:,41),nblabel17(:,1));
...
nbL17 = loss(parNaveBayesModel17.Trained{1},TLest_data17(:,1:40),TLest_data17(:,41));
nbConfusionTest17 = confusionchart(TLest_data17(:,41),nblabel17(:,1));
%%
nbconfMatrix18= confusionmat(TLest_data18(:,41),nblabel18(:,1));
...
nbL18 = loss(parNaveBayesModel18.Trained{1},TLest_data18(:,1:40),TLest_data18(:,41));
nbConfusionTest18 = confusionchart(TLest_data18(:,41),nblabel18(:,1));
%%
nbconfMatrix19= confusionmat(TLest_data19(:,41),nblabel19(:,1));
...
nbL19 = loss(parNaveBayesModel19.Trained{1},TLest_data19(:,1:40),TLest_data19(:,41));
nbConfusionTest19 = confusionchart(TLest_data19(:,41),nblabel19(:,1));
%%
nbconfMatrix20= confusionmat(TLest_data20(:,41),nblabel20(:,1));
...
nbL20 = loss(parNaveBayesModel20.Trained{1},TLest_data20(:,1:40),TLest_data20(:,41));
nbConfusionTest20 = confusionchart(TLest_data20(:,41),nblabel20(:,1));
%%
nbconfMatrix21= confusionmat(TLest_data21(:,41),nblabel21(:,1));
...
nbL21= loss(parNaveBayesModel21.Trained{1},TLest_data21(:,1:40),TLest_data21(:,41));
nbConfusionTest21 = confusionchart(TLest_data21(:,41),nblabel21(:,1));
%%
nbconfMatrix22= confusionmat(TLest_data22(:,41),nblabel22(:,1));
...
nbL22= loss(parNaveBayesModel22.Trained{1},TLest_data22(:,1:40),TLest_data22(:,41));
nbConfusionTest22 = confusionchart(TLest_data22(:,41),nblabel22(:,1));
%%
nbconfMatrix23= confusionmat(TLest_data23(:,41),nblabel23(:,1));
...
nbL23= loss(parNaveBayesModel23.Trained{1},TLest_data23(:,1:40),TLest_data23(:,41));
nbConfusionTest23 = confusionchart(TLest_data23(:,41),nblabel23(:,1));
%%
nbconfMatrix24= confusionmat(TLest_data24(:,41),nblabel24(:,1));
...
nbL24= loss(parNaveBayesModel24.Trained{1},TLest_data24(:,1:40),TLest_data24(:,41));
nbConfusionTest24 = confusionchart(TLest_data24(:,41),nblabel24(:,1));
%%
nbconfMatrix25= confusionmat(TLest_data25(:,41),nblabel25(:,1));
...
nbL25= loss(parNaveBayesModel25.Trained{1},TLest_data25(:,1:40),TLest_data25(:,41));
nbConfusionTest25 = confusionchart(TLest_data25(:,41),nblabel25(:,1));
%%
nbconfMatrix26= confusionmat(TLest_data26(:,41),nblabel26(:,1));
...
nbL26= loss(parNaveBayesModel26.Trained{1},TLest_data26(:,1:40),TLest_data26(:,41));
nbConfusionTest26 = confusionchart(TLest_data26(:,41),nblabel26(:,1));
%%
nbconfMatrix27= confusionmat(TLest_data27(:,41),nblabel27(:,1));
...
nbL27= loss(parNaveBayesModel27.Trained{1},TLest_data27(:,1:40),TLest_data27(:,41));
nbConfusionTest27 = confusionchart(TLest_data27(:,41),nblabel27(:,1));
%%
nbconfMatrix28= confusionmat(TLest_data28(:,41),nblabel28(:,1));
...
nbL28= loss(parNaveBayesModel28.Trained{1},TLest_data28(:,1:40),TLest_data28(:,41));
nbConfusionTest28 = confusionchart(TLest_data28(:,41),nblabel28(:,1));
%%
nbconfMatrix29= confusionmat(TLest_data29(:,41),nblabel29(:,1));
...
nbL29= loss(parNaveBayesModel29.Trained{1},TLest_data29(:,1:40),TLest_data29(:,41));
nbConfusionTest29 = confusionchart(TLest_data29(:,41),nblabel29(:,1));
%%
nbconfMatrix30= confusionmat(TLest_data30(:,41),nblabel30(:,1));
...
nbL30= loss(parNaveBayesModel30.Trained{1},TLest_data30(:,1:40),TLest_data30(:,41));
nbConfusionTest30 = confusionchart(TLest_data30(:,41),nblabel30(:,1));
%%
