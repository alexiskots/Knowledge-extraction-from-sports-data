%% q=6
quadconfMatrix01= confusionmat(TLest_data01(:,49),quadlabel01(:,1));
...
quadL01 = loss(quadpartitionedModel01.Trained{1},TLest_data01(:,1:48),TLest_data01(:,49));
quadConfusionTest01 = confusionchart(TLest_data01(:,49),quadlabel01(:,1));
%%
quadconfMatrix02= confusionmat(TLest_data02(:,49),quadlabel02(:,1));
...
quadL02 = loss(quadpartitionedModel02.Trained{1},TLest_data02(:,1:48),TLest_data02(:,49));
quadConfusionTest02 = confusionchart(TLest_data02(:,49),quadlabel02(:,1));
%%
quadconfMatrix03= confusionmat(TLest_data03(:,49),quadlabel03(:,1));
...
quadL03 = loss(quadpartitionedModel03.Trained{1},TLest_data03(:,1:48),TLest_data03(:,49));
quadConfusionTest03 = confusionchart(TLest_data03(:,49),quadlabel03(:,1));
%%
quadconfMatrix04= confusionmat(TLest_data04(:,49),quadlabel04(:,1));
...
quadL04 = loss(quadpartitionedModel04.Trained{1},TLest_data04(:,1:48),TLest_data04(:,49));
quadConfusionTest04 = confusionchart(TLest_data04(:,49),quadlabel04(:,1));
%%
quadconfMatrix05= confusionmat(TLest_data05(:,49),quadlabel05(:,1));
...
quadL05 = loss(quadpartitionedModel05.Trained{1},TLest_data05(:,1:48),TLest_data05(:,49));
quadConfusionTest05 = confusionchart(TLest_data05(:,49),quadlabel05(:,1));
%%
quadconfMatrix06= confusionmat(TLest_data06(:,49),quadlabel06(:,1));
...
quadL06 = loss(quadpartitionedModel06.Trained{1},TLest_data06(:,1:48),TLest_data06(:,49));
quadConfusionTest06 = confusionchart(TLest_data06(:,49),quadlabel06(:,1));
%%
quadconfMatrix07= confusionmat(TLest_data07(:,49),quadlabel07(:,1));
...
quadL07 = loss(quadpartitionedModel07.Trained{1},TLest_data07(:,1:48),TLest_data07(:,49));
quadConfusionTest07 = confusionchart(TLest_data07(:,49),quadlabel07(:,1));
%%
quadconfMatrix08= confusionmat(TLest_data08(:,49),quadlabel08(:,1));
...
quadL08 = loss(quadpartitionedModel08.Trained{1},TLest_data08(:,1:48),TLest_data08(:,49));
quadConfusionTest08 = confusionchart(TLest_data08(:,49),quadlabel08(:,1));
%%
quadconfMatrix09= confusionmat(TLest_data09(:,49),quadlabel09(:,1));
...
quadL09 = loss(quadpartitionedModel09.Trained{1},TLest_data09(:,1:48),TLest_data09(:,49));
quadConfusionTest09 = confusionchart(TLest_data09(:,49),quadlabel09(:,1));
%%
quadconfMatrix10= confusionmat(TLest_data10(:,49),quadlabel10(:,1));
...
quadL10 = loss(quadpartitionedModel10.Trained{1},TLest_data10(:,1:48),TLest_data10(:,49));
quadConfusionTest10 = confusionchart(TLest_data10(:,49),quadlabel10(:,1));
%%
quadconfMatrix11= confusionmat(TLest_data11(:,49),quadlabel11(:,1));
...
quadL11 = loss(quadpartitionedModel11.Trained{1},TLest_data11(:,1:48),TLest_data11(:,49));
quadConfusionTest11 = confusionchart(TLest_data11(:,49),quadlabel11(:,1));
%%
quadconfMatrix12= confusionmat(TLest_data12(:,49),quadlabel12(:,1));
...
quadL12 = loss(quadpartitionedModel12.Trained{1},TLest_data12(:,1:48),TLest_data12(:,49));
quadConfusionTest12 = confusionchart(TLest_data12(:,49),quadlabel12(:,1));
%%
quadconfMatrix13= confusionmat(TLest_data13(:,49),quadlabel13(:,1));
...
quadL13 = loss(quadpartitionedModel13.Trained{1},TLest_data13(:,1:48),TLest_data13(:,49));
quadConfusionTest13 = confusionchart(TLest_data13(:,49),quadlabel13(:,1));
%%
quadconfMatrix14= confusionmat(TLest_data14(:,49),quadlabel14(:,1));
...
quadL14 = loss(quadpartitionedModel14.Trained{1},TLest_data14(:,1:48),TLest_data14(:,49));
quadConfusionTest14 = confusionchart(TLest_data14(:,49),quadlabel14(:,1));
%%
quadconfMatrix15= confusionmat(TLest_data15(:,49),quadlabel15(:,1));
...
quadL15 = loss(quadpartitionedModel15.Trained{1},TLest_data15(:,1:48),TLest_data15(:,49));
quadConfusionTest15 = confusionchart(TLest_data15(:,49),quadlabel15(:,1));
%%
quadconfMatrix16= confusionmat(TLest_data16(:,49),quadlabel16(:,1));
...
quadL16 = loss(quadpartitionedModel16.Trained{1},TLest_data16(:,1:48),TLest_data16(:,49));
quadConfusionTest16 = confusionchart(TLest_data16(:,49),quadlabel16(:,1));
%%
quadconfMatrix17= confusionmat(TLest_data17(:,49),quadlabel17(:,1));
...
quadL17 = loss(quadpartitionedModel17.Trained{1},TLest_data17(:,1:48),TLest_data17(:,49));
quadConfusionTest17 = confusionchart(TLest_data17(:,49),quadlabel17(:,1));
%%
quadconfMatrix18= confusionmat(TLest_data18(:,49),quadlabel18(:,1));
...
quadL18 = loss(quadpartitionedModel18.Trained{1},TLest_data18(:,1:48),TLest_data18(:,49));
quadConfusionTest18 = confusionchart(TLest_data18(:,49),quadlabel18(:,1));
%%
quadconfMatrix19= confusionmat(TLest_data19(:,49),quadlabel19(:,1));
...
quadL19 = loss(quadpartitionedModel19.Trained{1},TLest_data19(:,1:48),TLest_data19(:,49));
quadConfusionTest19 = confusionchart(TLest_data19(:,49),quadlabel19(:,1));
%%
quadconfMatrix20= confusionmat(TLest_data20(:,49),quadlabel20(:,1));
...
quadL20 = loss(quadpartitionedModel20.Trained{1},TLest_data20(:,1:48),TLest_data20(:,49));
quadConfusionTest20 = confusionchart(TLest_data20(:,49),quadlabel20(:,1));
%%
quadconfMatrix21= confusionmat(TLest_data21(:,49),quadlabel21(:,1));
...
quadL21= loss(quadpartitionedModel21.Trained{1},TLest_data21(:,1:48),TLest_data21(:,49));
quadConfusionTest21 = confusionchart(TLest_data21(:,49),quadlabel21(:,1));
%%
quadconfMatrix22= confusionmat(TLest_data22(:,49),quadlabel22(:,1));
...
quadL22= loss(quadpartitionedModel22.Trained{1},TLest_data22(:,1:48),TLest_data22(:,49));
quadConfusionTest22 = confusionchart(TLest_data22(:,49),quadlabel22(:,1));
%%
quadconfMatrix23= confusionmat(TLest_data23(:,49),quadlabel23(:,1));
...
quadL23= loss(quadpartitionedModel23.Trained{1},TLest_data23(:,1:48),TLest_data23(:,49));
quadConfusionTest23 = confusionchart(TLest_data23(:,49),quadlabel23(:,1));
%%
quadconfMatrix24= confusionmat(TLest_data24(:,49),quadlabel24(:,1));
...
quadL24= loss(quadpartitionedModel24.Trained{1},TLest_data24(:,1:48),TLest_data24(:,49));
quadConfusionTest24 = confusionchart(TLest_data24(:,49),quadlabel24(:,1));
%%
quadconfMatrix25= confusionmat(TLest_data25(:,49),quadlabel25(:,1));
...
quadL25= loss(quadpartitionedModel25.Trained{1},TLest_data25(:,1:48),TLest_data25(:,49));
quadConfusionTest25 = confusionchart(TLest_data25(:,49),quadlabel25(:,1));
%%
quadconfMatrix26= confusionmat(TLest_data26(:,49),quadlabel26(:,1));
...
quadL26= loss(quadpartitionedModel26.Trained{1},TLest_data26(:,1:48),TLest_data26(:,49));
quadConfusionTest26 = confusionchart(TLest_data26(:,49),quadlabel26(:,1));
%%
quadconfMatrix27= confusionmat(TLest_data27(:,49),quadlabel27(:,1));
...
quadL27= loss(quadpartitionedModel27.Trained{1},TLest_data27(:,1:48),TLest_data27(:,49));
quadConfusionTest27 = confusionchart(TLest_data27(:,49),quadlabel27(:,1));
%%
quadconfMatrix28= confusionmat(TLest_data28(:,49),quadlabel28(:,1));
...
quadL28= loss(quadpartitionedModel28.Trained{1},TLest_data28(:,1:48),TLest_data28(:,49));
quadConfusionTest28 = confusionchart(TLest_data28(:,49),quadlabel28(:,1));
%%
quadconfMatrix29= confusionmat(TLest_data29(:,49),quadlabel29(:,1));
...
quadL29= loss(quadpartitionedModel29.Trained{1},TLest_data29(:,1:48),TLest_data29(:,49));
quadConfusionTest29 = confusionchart(TLest_data29(:,49),quadlabel29(:,1));
%%
quadconfMatrix30= confusionmat(TLest_data30(:,49),quadlabel30(:,1));
...
quadL30= loss(quadpartitionedModel30.Trained{1},TLest_data30(:,1:48),TLest_data30(:,49));
quadConfusionTest30 = confusionchart(TLest_data30(:,49),quadlabel30(:,1));
%%
