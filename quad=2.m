...
quadClassificationSVM01 = fitcsvm(TLrain_data01(:,1:16 ),TLrain_data01(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel01 = crossval(quadClassificationSVM01, 'KFold', 10);
quadpartitionedModel01.Trained{1};
quadlabel01 = predict(quadpartitionedModel01.Trained{1},TLest_data01(:,1:16 ));
%%
...
quadClassificationSVM02 = fitcsvm(TLrain_data02(:,1:16 ),TLrain_data02(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel02 = crossval(quadClassificationSVM02, 'KFold', 10);
quadpartitionedModel02.Trained{1};
quadlabel02 = predict(quadpartitionedModel02.Trained{1},TLest_data02(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM03 = fitcsvm(TLrain_data03(:,1:16 ),TLrain_data03(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel03 = crossval(quadClassificationSVM03, 'KFold', 10);
quadpartitionedModel03.Trained{1};
quadlabel03 = predict(quadpartitionedModel03.Trained{1},TLest_data03(:,1:16 ));
%%
...
quadClassificationSVM04 = fitcsvm(TLrain_data04(:,1:16 ),TLrain_data04(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel04 = crossval(quadClassificationSVM04, 'KFold', 10);
quadpartitionedModel04.Trained{1};
quadlabel04 = predict(quadpartitionedModel04.Trained{1},TLest_data04(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM05= fitcsvm(TLrain_data05(:,1:16 ),TLrain_data05(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel05 = crossval(quadClassificationSVM05, 'KFold', 10);
quadpartitionedModel05.Trained{1};
quadlabel05 = predict(quadpartitionedModel05.Trained{1},TLest_data05(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM06= fitcsvm(TLrain_data06(:,1:16 ),TLrain_data06(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel06 = crossval(quadClassificationSVM06, 'KFold', 10);
quadpartitionedModel06.Trained{1};
quadlabel06 = predict(quadpartitionedModel06.Trained{1},TLest_data06(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM07= fitcsvm(TLrain_data07(:,1:16 ),TLrain_data07(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel07 = crossval(quadClassificationSVM07, 'KFold', 10);
quadpartitionedModel07.Trained{1};
quadlabel07 = predict(quadpartitionedModel07.Trained{1},TLest_data07(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM08= fitcsvm(TLrain_data08(:,1:16 ),TLrain_data08(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel08 = crossval(quadClassificationSVM08, 'KFold', 10);
quadpartitionedModel08.Trained{1};
quadlabel08 = predict(quadpartitionedModel08.Trained{1},TLest_data08(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM09= fitcsvm(TLrain_data09(:,1:16 ),TLrain_data09(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel09 = crossval(quadClassificationSVM09, 'KFold', 10);
quadpartitionedModel09.Trained{1};
quadlabel09 = predict(quadpartitionedModel09.Trained{1},TLest_data09(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM10= fitcsvm(TLrain_data10(:,1:16 ),TLrain_data10(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel10 = crossval(quadClassificationSVM10, 'KFold', 10);
quadpartitionedModel10.Trained{1};
quadlabel10 = predict(quadpartitionedModel10.Trained{1},TLest_data10(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM11= fitcsvm(TLrain_data11(:,1:16 ),TLrain_data11(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel11 = crossval(quadClassificationSVM11, 'KFold', 10);
quadpartitionedModel11.Trained{1};
quadlabel11 = predict(quadpartitionedModel11.Trained{1},TLest_data11(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM12= fitcsvm(TLrain_data12(:,1:16 ),TLrain_data12(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel12 = crossval(quadClassificationSVM12, 'KFold', 10);
quadpartitionedModel12.Trained{1};
quadlabel12 = predict(quadpartitionedModel12.Trained{1},TLest_data12(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM13= fitcsvm(TLrain_data13(:,1:16 ),TLrain_data13(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel13 = crossval(quadClassificationSVM13, 'KFold', 10);
quadpartitionedModel13.Trained{1};
quadlabel13 = predict(quadpartitionedModel13.Trained{1},TLest_data13(:,1:16 ));
%%
...
quadClassificationSVM14= fitcsvm(TLrain_data14(:,1:16 ),TLrain_data14(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel14 = crossval(quadClassificationSVM14, 'KFold', 10);
quadpartitionedModel14.Trained{1};
quadlabel14 = predict(quadpartitionedModel14.Trained{1},TLest_data14(:,1:16 ));
%%
...
quadClassificationSVM15= fitcsvm(TLrain_data15(:,1:16 ),TLrain_data15(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel15 = crossval(quadClassificationSVM15, 'KFold', 10);
quadpartitionedModel15.Trained{1};
quadlabel15 = predict(quadpartitionedModel15.Trained{1},TLest_data15(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM16= fitcsvm(TLrain_data16(:,1:16 ),TLrain_data16(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel16 = crossval(quadClassificationSVM16, 'KFold', 10);
quadpartitionedModel16.Trained{1};
quadlabel16 = predict(quadpartitionedModel16.Trained{1},TLest_data16(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM17= fitcsvm(TLrain_data17(:,1:16 ),TLrain_data17(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel17 = crossval(quadClassificationSVM17, 'KFold', 10);
quadpartitionedModel17.Trained{1};
quadlabel17 = predict(quadpartitionedModel17.Trained{1},TLest_data17(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM18= fitcsvm(TLrain_data18(:,1:16 ),TLrain_data18(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel18 = crossval(quadClassificationSVM18, 'KFold', 10);
quadpartitionedModel18.Trained{1};
quadlabel18 = predict(quadpartitionedModel18.Trained{1},TLest_data18(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM19= fitcsvm(TLrain_data19(:,1:16 ),TLrain_data19(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel19 = crossval(quadClassificationSVM19, 'KFold', 10);
quadpartitionedModel19.Trained{1};
quadlabel19 = predict(quadpartitionedModel19.Trained{1},TLest_data19(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM20= fitcsvm(TLrain_data20(:,1:16 ),TLrain_data20(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel20 = crossval(quadClassificationSVM20, 'KFold', 10);
quadpartitionedModel20.Trained{1};
quadlabel20 = predict(quadpartitionedModel20.Trained{1},TLest_data20(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM21= fitcsvm(TLrain_data21(:,1:16 ),TLrain_data21(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel21 = crossval(quadClassificationSVM21, 'KFold', 10);
quadpartitionedModel21.Trained{1};
quadlabel21 = predict(quadpartitionedModel21.Trained{1},TLest_data21(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM22= fitcsvm(TLrain_data22(:,1:16 ),TLrain_data22(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel22 = crossval(quadClassificationSVM22, 'KFold', 10);
quadpartitionedModel22.Trained{1};
quadlabel22 = predict(quadpartitionedModel22.Trained{1},TLest_data22(:,1:16 ));
%%
...
quadClassificationSVM23= fitcsvm(TLrain_data23(:,1:16 ),TLrain_data23(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel23 = crossval(quadClassificationSVM23, 'KFold', 10);
quadpartitionedModel23.Trained{1};
quadlabel23 = predict(quadpartitionedModel23.Trained{1},TLest_data23(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM24= fitcsvm(TLrain_data24(:,1:16 ),TLrain_data24(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel24 = crossval(quadClassificationSVM24, 'KFold', 10);
quadpartitionedModel24.Trained{1};
quadlabel24 = predict(quadpartitionedModel24.Trained{1},TLest_data24(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM25= fitcsvm(TLrain_data25(:,1:16 ),TLrain_data25(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel25= crossval(quadClassificationSVM25, 'KFold', 10);
quadpartitionedModel25.Trained{1};
quadlabel25 = predict(quadpartitionedModel25.Trained{1},TLest_data25(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM26= fitcsvm(TLrain_data26(:,1:16 ),TLrain_data26(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel26= crossval(quadClassificationSVM26, 'KFold', 10);
quadpartitionedModel26.Trained{1};
quadlabel26 = predict(quadpartitionedModel26.Trained{1},TLest_data26(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM27= fitcsvm(TLrain_data27(:,1:16 ),TLrain_data27(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel27= crossval(quadClassificationSVM27, 'KFold', 10);
quadpartitionedModel27.Trained{1};
quadlabel27 = predict(quadpartitionedModel27.Trained{1},TLest_data27(:,1:16 ));
%%
for i=1:81
...
quadClassificationSVM28= fitcsvm(TLrain_data28(:,1:16 ),TLrain_data28(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel28= crossval(quadClassificationSVM28, 'KFold', 10);
quadpartitionedModel28.Trained{1};
quadlabel28 = predict(quadpartitionedModel28.Trained{1},TLest_data28(:,1:16 ));
%%
...
quadClassificationSVM29= fitcsvm(TLrain_data29(:,1:16 ),TLrain_data29(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel29= crossval(quadClassificationSVM29, 'KFold', 10);
quadpartitionedModel29.Trained{1};
quadlabel29 = predict(quadpartitionedModel29.Trained{1},TLest_data29(:,1:16 ));
%%
...
quadClassificationSVM30= fitcsvm(TLrain_data30(:,1:16 ),TLrain_data30(:,17),'KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1, 'Standardize', true,  'ClassNames', [0; 1]);
quadpartitionedModel30= crossval(quadClassificationSVM30, 'KFold', 10);
quadpartitionedModel30.Trained{1};
quadlabel30 = predict(quadpartitionedModel30.Trained{1},TLest_data30(:,1:16 ));